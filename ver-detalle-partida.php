...
<?php include("menu-flotante.php"); ?>
        ...
        <main class="main home">
			...
			<section class="kenBurns-section mt-5 pt-5">
				<h3 class="text-center">Reporte detallado de exportaciones de la partida seleccionada - Año: <?=$code2;?> │ Mes: <?=$nommes;?></h3>
...
e.PART_NANDI = '$code3'
  ...
  and CONCAT(e.DCOM,e.DMER2,e.DMER3,e.DMER4,e.DMER5) like '%".$code1."%'	
