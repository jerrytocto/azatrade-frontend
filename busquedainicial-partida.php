...
$cxreg = "SELECT COUNT(*) as total FROM (SELECT e.part_nandi  FROM exportacion e WHERE YEAR(e.fnum) ='$dato2' AND e.part_nandi='$dato' GROUP BY e.part_nandi) AS Total";
...
exportacion e
WHERE
YEAR(e.fnum) ='$dato2' AND e.part_nandi='$dato' GROUP BY anio,e.part_nandi";
					...
					<div class="row">
						...
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Ver Detalle</h4>
									<p><a href="ver-resumen-detalle-partida?dat=<?=$tbb10;?>&year=<?=$dato2;?>&pk=<?=$tbb2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<!--<div class="col-xl-3 col-md-6">
