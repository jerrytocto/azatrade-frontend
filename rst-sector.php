...
$cxreg = "SELECT COUNT(*) as total FROM (SELECT e.NDOC FROM GranResumenExport_PowerBI as e WHERE e.aniofn ='2022' AND  e.PART_NANDI='$dato' GROUP BY e.NDOC) AS Total";
    ...
    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-action">
                                        <a href="partida-empresas-detalle?dat=<?=$tbb6;?>&year=2022" target="_blank" class="btn-icon btn-add-cart active" style="color: #000000; background-color: #FFFFFF;">
