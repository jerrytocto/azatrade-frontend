...
ini_set('memory_limit', '3800M'); // uso de memoria 3.8G
...
/* $sqllist= "SELECT r.aniofn, r.mesfn as mes, CONVERT(r.mesfn,UNSIGNED INTEGER) as mesfn, sum(r.VFOB) AS VFOBSERDOL, sum(r.cantreg) AS cantreg 
	...
	WHERE r.libr_tribu = '$code1' AND r.aniofn = '$code2' AND r.part_nandi = '$code3' 
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle-uso-general?year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
