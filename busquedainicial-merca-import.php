...
WHERE
e.aniofn ='$dato2' AND e.pais_orige='$dato' GROUP BY anio,e.part_nandi ORDER BY vfobx1 DESC";
...
?>
	<tr>
		...
		<td>
		<a href="ver-resumen-detalle-mercado-import?dat=<?=$dato;?>&year=<?=$dato2;?>&pk=<?=$tbb2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-sm">Ver Detalle</button></a>
		</td>
	</tr>
<?php } ?>
