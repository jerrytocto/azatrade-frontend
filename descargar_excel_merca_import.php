...
header("Content-Disposition: attachment;filename=Reporte_Importaciones_azatrade_23.xls ");  
...
<!-- DIV DONDE SE MOSTRARÁ  LA TABLA DE CONTENIDOS -->
	...
	MONTH(i.fech_ingsi) = '$mes' AND 
	i.part_nandi = '$party' AND i.pais_orige='$idpais' ";
