<div class="sidebar" data-color="azure" data-background-color="black" data-image="img/sidebar-1.jpg">
    ...
    <div class="logo">
        ...
        <font size="2"><font color="#FFFFFF">Exportaciones</font></font>
    </div>
      ...
      <?php } ?>
       <?php if (isset($_SESSION['login_usuario'])){ ?>
        ...
        <ul class="nav">
            ...
            <li class="nav-item <?=$activepartidos;?>">
                <a class="nav-link" href="partida2.php">
                    <i class="material-icons">spellcheck</i>
                    <p> Partidas DOS </p>
                </a>
            </li>
            ...
            <li class="nav-item <?=$activemercapbi;?>">
            ...
            <li class="nav-item <?=$activemani;?>">
                <a class="nav-link" href="http://www.sunat.gob.pe/aduanas/informli/ildua.htm" target="_blank">
                    <i class="material-icons">pan_tool</i>
                    <p> Buscar Manifiesto </p>
                </a>
            </li>
            ...
            <div class="collapse <?=$areashow;?>" id="pagesBus">
              <ul class="nav">
                <li class="nav-item  <?=$busarea;?>">
                  <a class="nav-link" href="http://www.aduanet.gob.pe/cl-ad-itconsmanifiesto/manifiestoITS01Alias?accion=cargaConsultaManifiesto&tipoConsulta=numeroManifiesto" target="_blank">
                    <i class="material-icons"> brightness_auto </i>
                    <span class="sidebar-normal"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Aéra del Callao </span>
                  </a>
                </li>
                <li class="nav-item <?=$maritimaca;?>">
                  <a class="nav-link" href="http://www.aduanet.gob.pe/cl-ad-itconsmanifiesto/manifiestoITS01Alias?accion=cargarFrmConsultaManifiestoExportacion" target="_blank">
                    <i class="material-icons"> directions_boat </i>
                    <span class="sidebar-normal"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Marítima del Callao </span>
                  </a>
                </li>
                <li class="nav-item <?=$areaadua;?>">
                  <a class="nav-link" href="http://www.aduanet.gob.pe/cl-ad-itconsmanifiesto/manifiestoITS01Alias?accion=cargaConsultaManifiesto&tipoConsulta=salidaProvincia" target="_blank">
            ...
            <li class="nav-item <?=$activepadm;?>">
                ...
                <div class="collapse <?=$actibtn;?> " id="pagesExamples">
                    <ul class="nav">
						...
						<li class="nav-item <?=$activerptprodu;?>">
                            <a class="nav-link" href="rpt-productos.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Productos </span>
                            </a>
                        </li>
						<li class="nav-item <?=$activerptemppr;?>">
                            <a class="nav-link" href="rpt-empresas.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Empresas </span>
                            </a>
                        </li>
                        <li class="nav-item <?=$activeproce;?>">
                            <a class="nav-link" href="resumen_procesa.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Procesar Resumenes </span>
                            </a>
                        </li>
                        <li class="nav-item <?=$activemensa;?>">
                            <a class="nav-link" href="actualizalert.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Actualizar Mensajes </span>
                            </a>
                        </li>
                        
                        <li class="nav-item <?=$activesol;?>">
