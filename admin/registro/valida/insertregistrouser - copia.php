...
Para validar tu cuenta creada dale click <a href="http://www.azatrade.info/demo/valida/?key='.$passacti.'">aqui</a> o copia este link en tu navegador (http://www.azatrade.info/demo/valida/?key='.$passacti.') para validar tu cuenta de correo ingresado (si no validas tu cuenta en un tiempo de 24 horas el sistema eliminara el registro creado)
