...
FROM exportacion
/*LEFT JOIN arancel ON (CASE char_length(exportacion.part_nandi::TEXT) WHEN '9' THEN '0' || exportacion.part_nandi ELSE exportacion.part_nandi::TEXT END) = arancel.idarancel*/ WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND $wherefecha ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion
/*LEFT JOIN arancel ON (CASE char_length(exportacion.part_nandi::TEXT) WHEN '9' THEN '0' || exportacion.part_nandi ELSE exportacion.part_nandi::TEXT END) = arancel.idarancel*/
WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND $wherefecha GROUP BY exportacion.part_nandi/*,arancel.descripcion*/";
  }else if($nombres2=="total"){
	  $query_resultado = "SELECT
exportacion.part_nandi,
/*arancel.descripcion,*/
...
$wherefecha GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Ubigeo Evolucion Anual de Exportaciones</b><br> Departamento: $namedato │ Variable #1: $combo - Variable #2: $combo2 │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
FROM exportacion
/*LEFT JOIN arancel ON (CASE char_length(exportacion.part_nandi::TEXT) WHEN '9' THEN '0' || exportacion.part_nandi ELSE exportacion.part_nandi::TEXT END) = arancel.idarancel*/
WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ORDER BY xx2020 DESC LIMIT 5";
  }else if($nombres2=="total"){
	  $query_resultado = "SELECT
exportacion.part_nandi,
/*arancel.descripcion,*/
...
exportacion
/*LEFT JOIN arancel ON (CASE char_length(exportacion.part_nandi::TEXT) WHEN '9' THEN '0' || exportacion.part_nandi ELSE exportacion.part_nandi::TEXT END) = arancel.idarancel*/
WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ORDER BY a2020 DESC LIMIT 5";
  }else{
	  if($nombres2=="provi"){
		  $variaA='substring(exportacion.ubigeo,3,2)';
	  }else{
...
?>
      ...
      var options = {
        title: 'Ubigeo: <?php echo $namedato ?> - Evolución Anual <?php echo $combo ?> <?php echo $combo2 ?> de Exportaciones Periodo 2012 - 2021',
        chartArea: {width: '50%'},
        isStacked: true,
        hAxis: {
...
/*if($nombres3=="empresaexpo"){//consulta como variable pais exportadoras
...
if($nombres3=="empresaexpo"){//consulta como variable pais
include("mercado_evoanualC.php");
}
