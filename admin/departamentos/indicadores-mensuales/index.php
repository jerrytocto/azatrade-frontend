...
set_time_limit(500);
$namedato = $_POST["namedepaB"];
$codeid = $_POST["codedepaB"];
$anio = $_POST["years"];
...
/*sumamos valorfob*/
		   ...
		   FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2) = '$codeid'";
...
SUM(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.vpesbru ELSE 0 END) AS diciembre FROM exportacion where extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_qunicom=$resultado_qunicom->fetch_array()){
	  ...
	  $query_parti = "SELECT Count(DISTINCT exportacion.part_nandi) as cant_parti, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_parti=$resultado_parti->fetch_array()){
	  ...
	  $generalA = "SELECT Count(DISTINCT exportacion.part_nandi) as cant_parti FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_creg=$resultado_creg->fetch_array()){
	  ...
	  /*cuenta cantidad de duas*/
	   $query_dua = "SELECT Count(DISTINCT exportacion.ndcl) as cant_dua, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_dua=$resultado_dua->fetch_array()){
	  ...
	  $generalB = "SELECT Count(DISTINCT exportacion.ndcl) as cant_dua FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_generaB=$res_generaB->fetch_array()){
	  ...
	  /*cuenta cantidad de empresas*/
	   $query_emp = "SELECT Count(DISTINCT exportacion.dnombre) as cant_nom, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_emp=$resultado_emp->fetch_array()){
	  ...
	  $generalC = "SELECT Count(DISTINCT exportacion.dnombre) as cant_nom FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_generaC=$res_generaC->fetch_array()){
	 ...
	 $query_merca = "SELECT Count(DISTINCT exportacion.cpaides) as cant_mer, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_merca=$resultado_merca->fetch_array()){
	...
	/*total general de mercados*/
	  $generalC = "SELECT Count(DISTINCT exportacion.cpaides) as cant_mer FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
				$res_generaC=$conexpg->query($generalC); 
if($res_generaC->num_rows>0){ 
while($fila_generaC=$res_generaC->fetch_array()){
	  ...
	  /*contamos cantidad de puertos*/
	   $query_pue = "SELECT Count(DISTINCT exportacion.cpuedes) as cant_pue, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_pue=$resultado_pue->fetch_array()){
	  ...
	  $generalD = "SELECT Count(DISTINCT exportacion.cpuedes) as cant_pue FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_generaD=$res_generaD->fetch_array()){
	  ...
	  /*contamos cantidad de aduanas*/
	   $query_adua = "SELECT Count(DISTINCT exportacion.cadu) as cant_adua, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_adua=$resultado_adua->fetch_array()){
	  ...
	  $generalE = "SELECT Count(DISTINCT exportacion.cadu) as cant_adua FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_generaE=$res_generaE->fetch_array()){
	  ...
	  /*$generalF = "SELECT COUNT(DISTINCT departamento.nombre) as departamento FROM exportacion LEFT JOIN departamento ON  ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) WHERE extract(year from exportacion.fnum)= '$anio' AND exportacion.ndoc='$paiscode' ";
	  ...
	  /*contamnos cantidad de distrito*/
	   /*$query_dist = "SELECT count(DISTINCT distrito.nombre) AS distrito, extract(MONTH from exportacion.fnum) AS mes FROM exportacion LEFT JOIN distrito ON exportacion.ubigeo= distrito.iddistrito WHERE extract(year from exportacion.fnum)= '$anio' AND exportacion.ndoc='$paiscode' GROUP BY mes ORDER BY mes ASC";
	  ...
	  /*$generalH = "SELECT count(DISTINCT distrito.nombre) AS distrito FROM exportacion LEFT JOIN distrito ON exportacion.ubigeo= distrito.iddistrito WHERE extract(year from exportacion.fnum)= '$anio' AND exportacion.ndoc='$paiscode' ";
	  ...
	  /*contamnos cantidad de agente*/
	   $query_agen = "SELECT Count(DISTINCT exportacion.cage) as cant_agen, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_agen=$resultado_agen->fetch_array()){
	  ...
	  $generalI = "SELECT Count(DISTINCT exportacion.cage) as cant_agen FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
while($fila_generaI=$res_generaI->fetch_array()){
	  ...
	  /*contamos cantidad via de transporte*/
	   $query_via = "SELECT Count(DISTINCT exportacion.cviatra) as cant_via, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' GROUP BY mes order BY mes ASC";
...
while($fila_via=$resultado_via->fetch_array()){
	  ...
	  $generalJ = "SELECT Count(DISTINCT exportacion.cviatra) as cant_via FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND substring(exportacion.ubigeo,1,2)='$codeid' ";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Analisis Ubigeo Indicador Mensual - Exportaciones </b><br> Ubigeo: $namedato │ Fecha Numeracion │ Periodo $anio </b> </h4>
            </div>";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            title: 'Reporte Analisis Ubigeo Mensual <?php echo $namedato ?> - Exportaciones',
