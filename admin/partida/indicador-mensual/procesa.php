...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.ndcl ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.ndcl ELSE null END )) AS mes12
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1'";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.dnombre ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.dnombre ELSE null END )) AS mes12 
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.cpaides ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.cpaides ELSE null END )) AS mes12 
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.cpuedes ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.cpuedes ELSE null END )) AS mes12
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.cadu ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.cadu ELSE null END )) AS mes12 
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN departamento.nombre ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN departamento.nombre ELSE null END )) AS mes12 
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.cage ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.cage ELSE null END )) AS mes12 
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '11' THEN exportacion.cviatra ELSE null END )) AS mes11,
count(DISTINCT(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.cviatra ELSE null END )) AS mes12 
FROM exportacion WHERE extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1' ";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Mensual de Indicadores - Exportaciones</b><br> Partida #: $partida1 │ Departamento: $namedepa1 │ Fecha Numeración │ Periodo $anio </b> </h4>
            </div>";
