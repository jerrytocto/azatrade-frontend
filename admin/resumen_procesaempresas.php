...
while($fila_year=$result_year->fetch_array()){
		  ...
		  $sumatotal2018_x= $fila_year['a2018'];
		   ...
		   if($sumatotal2020_x=='0'){
			   ...
			   $sum_totalfob9 = $fila_year['a2019'];
			   $sum_totalnet9 = $fila_year['a2019x'];
		   ...
		   if($sumatotal2021_x=='0'){
			   ...
			   $sum_totalfob10 = $fila_year['a2020'];
			   $sum_totalnet10 = $fila_year['a2020x'];
		   ...
		   $sumatotal2019= $sumc8x + $sumatotal2019;
			   ...
			   $sumatotal2021= $sumc9x + $sumatotal2021;
		   }else{
...
if($resultado1->num_rows>0){ 
	...
	//eliminamos registro
				  $Sqldelempre="DELETE FROM resumen_empresas WHERE varia_filtro ='$nombres2' ";
				  $rs = $conexpg->query($Sqldelempre);
...
echo "<td>$var22%</td>";
 echo "</tr>";*/
				  ...
				  $Sql_inserempre="insert into resumen_empresas (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, anio9, anio10, variauno, variados
)  values (
'$nombres2',
'$cod_emp',
'$nom_emp',
...
'$var11',
'$var22' )";
	$rscrea2 = $conexpg->query($Sql_inserempre);
...
/*echo"<thead>";
	...
	$Sql_inseremprecatota="insert into resumen_empresas (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, anio9, anio10, variauno, variados
)  values (
'$nombres2',
'Total',
'Totales',
...
'$varitota',
'$parti' )";
	$rscreatota = $conexpg->query($Sql_inseremprecatota);
...
echo"<script>location.href='resumen_procesa.php?by=ok&val=Empresas&fit=$combo'</script>";
?>
</html>