...
FROM exportacion
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.cpuedes,puerto.puerto ";
...
".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.cpuedes,puerto.puerto ";
...
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod'
GROUP BY exportacion.cpuedes,puerto.puerto ORDER BY a2018 DESC LIMIT 5";
  }else if ($nombres2=="diferen"){
	  $query_resultado = "SELECT
exportacion.cpuedes,
puerto.puerto,
...
FROM exportacion
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.cpuedes,puerto.puerto ORDER BY xx2018 DESC LIMIT 5";
  }else if($nombres2=="total"){
	  $query_resultado = "SELECT
exportacion.cpuedes,
puerto.puerto,
...
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaide = '".$paiscode."' AND
".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.cpuedes,puerto.puerto ORDER BY a2018 DESC LIMIT 5";
  } else if($nombres2=="part_nandi" or $nombres2=="ndcl" or $nombres2=="dnombre" or $nombres2=="cpaides" or $nombres2=="cpuedes" or  $nombres2=="cadu" or $nombres2=="cage" or $nombres2=="cviatra"){
	  $query_resultado = "SELECT
exportacion.cpuedes,
puerto.puerto,
...
exportacion
LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.cpuedes,puerto.puerto ORDER BY a2018 DESC LIMIT 5";
  }else{
