...
extract(year from exportacion.fnum) <= '2021' $queryu ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
/*LEFT JOIN arancel ON exportacion.part_nandi = arancel.idarancel*/
WHERE exportacion.cpaides = '".$paiscode."' AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' $queryu GROUP BY exportacion.part_nandi/*,arancel.descripcion*/";
  }else if($nombres2=="total"){
	  $query_resultado = "SELECT
exportacion.part_nandi,
/*arancel.descripcion,*/
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Mercado Evolucion Mensual de Exportaciones</b><br> Mercado: $paisname │ Departamento: $namedepa1 │ Indicador #1: $combo - Variable #2: $combo2 │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
FROM exportacion
/*LEFT JOIN arancel ON exportacion.part_nandi = arancel.idarancel*/
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ORDER BY xx2020 DESC LIMIT 5";
  }else if($nombres2=="total"){
	  $query_resultado = "SELECT
exportacion.part_nandi,
/*arancel.descripcion,*/
...
/*LEFT JOIN arancel ON exportacion.part_nandi = arancel.idarancel*/
WHERE exportacion.cpaides = '".$paiscode."' AND
".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ORDER BY a2020 DESC LIMIT 5";
  } else if($nombres2=="part_nandi" or $nombres2=="ndcl" or $nombres2=="dnombre" or $nombres2=="cpaides" or $nombres2=="cpuedes" or  $nombres2=="cadu" or $nombres2=="cage" or $nombres2=="cviatra"){
	  $query_resultado = "SELECT
exportacion.part_nandi,
/*arancel.descripcion,*/
...
exportacion
/*LEFT JOIN arancel ON exportacion.part_nandi = arancel.idarancel*/
WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' GROUP BY exportacion.part_nandi/*,arancel.descripcion*/ ORDER BY a2020 DESC LIMIT 5";
  }else{
	  if($nombres2=="depa"){
		  $variaA='substring(exportacion.ubigeo,1,2)';
	  }else if($nombres2=="provi"){
