...
if($ubicod1!=""){
	$flatcod = $ubicod1;
	//$queryu = "AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod'";
...
/*realizamos conusulta del reporte selecionado y  actualizamos en la tabla temporal crada*/
 ...
 WHERE exportacion.cpaides='".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="vpesnet"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.vpesnet) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="diferen"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.vfobserdol) / Sum(exportacion.vpesnet) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="vpesbru"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.vpesbru) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
   if($onevar=="qunifis"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.qunifis) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="qunicom"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.qunicom) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="part_nandi"){
	  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.part_nandi) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="total"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, count(*) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="ndcl"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.ndcl) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="dnombre"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.dnombre) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="cpaides"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.cpaides) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="cpuedes"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.cpuedes) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="cadu"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.cadu) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2020' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
   if($onevar=="depa"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT departamento.nombre) as resultado FROM exportacion LEFT JOIN departamento ON ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) WHERE  exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021'
GROUP BY exportacion.fano,mes order BY exportacion.fano, resultado ASC";
  }
  if($onevar=="provi"){
  $query1 = "SELECT exportacion.fano , extract(MONTH from exportacion.fnum) as mes, count(DISTINCT provincia.nombre) as resultado FROM exportacion LEFT JOIN departamento ON  (((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))  INNER JOIN provincia ON provincia.iddepartamento = departamento.iddepartamento  WHERE  exportacion.cpaides =  '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano ASC";
  }
  
  if($onevar=="distri"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT distrito.nombre) as resultado FROM exportacion LEFT JOIN departamento ON ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) INNER JOIN provincia ON provincia.iddepartamento = departamento.iddepartamento  INNER JOIN distrito ON distrito.idprovincia = provincia.idprovincia WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano ASC ";
  }
   if($onevar=="cage"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.cage) as resultado FROM exportacion WHERE  exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="cviatra"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes,COUNT(DISTINCT exportacion.cviatra) as resultado FROM exportacion WHERE exportacion.cpaides = '".$paiscode."' $queryu AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
...
while($fila1=$resultado1->fetch_array()){
 ...
 $rs = $conexpg->query($insert1);
  ...
  if (!$delete1) {
    echo "Query: Un Error ha Occurido al Eliminar la Tabla Temporal";
  }else{
...
extract(year from exportacion.fnum) <= '2021' $queryu AND exportacion.cpaides ='".$paiscode."'";
...
extract(year from exportacion.fnum) <= '2021' $queryu AND exportacion.cpaides ='".$paiscode."' GROUP BY anio order BY anio ASC";
...
while($fila_year=$result_year->fetch_array()){
		...
		if($sumatotal2012=='0'){
			  ...
			  $varitota= number_format((($sumatotal2020 / $sumatotal2019) - 1) * 100,2);
			  $parti= number_format(($ca1_6 + $ca2_6 + $ca3_6 + $ca4_6 + $ca5_6 + $ca6_6 + $ca7_6 + $ca7_6)/8,2) ;
			 ...
			 if($sumatotal2018=='0' or $sumatotal2018 == null){
			  ...
			  $varitota= number_format((($sumatotal2020 / $sumatotal2019) - 1) * 100,2);
			  $parti= number_format(($ca1_9x + $ca2_9x + $ca3_9x + $ca4_9x + $ca5_9x + $ca6_9x + $ca7_9x + $ca8_9x)/8,2) ;
	    ...
	    $parti= number_format(($ca1_dis + $ca2_dis + $ca3_dis + $ca4_dis + $ca5_dis + $ca6_dis + $ca7_dis + $ca8_dis)/8,2) ;
		      ...
		      $ca8_10 = (($sumatotal2019 / $sumatotal2018) - 1) * 100;
		      }
		      ...
		      $ca6_11 = (($sumatotal2018 / $sumatotal2017) - 1) * 100;
				   ...
				   if($sumatotal2018=='0' or $sumatotal2017 == null){
			  $ca7_11 ='0';
		      }else{
		      $ca7_11 = (($sumatotal2019 / $sumatotal2018) - 1) * 100;
		      }
				   if($sumatotal2019=='0' or $sumatotal2018 == null){
			  $ca8_11 ='0';
		      }else{
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Mercado Evolucion Anual de Exportaciones</b><br> Mercado: $paisname │ Departamento: $namedepa1 │ Variable: $combo │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
while($fila_rptx=$resultado_rptx->fetch_array()){
	...
	$year12x= $fila_rptx['a2021'];
		  ?>
		  ['<?php echo $nombredescx2; ?>',  <?php echo $year3x; ?>, <?php echo $year4x; ?>, <?php echo $year5x; ?>, <?php echo $year6x; ?>, <?php echo $year7x; ?>, <?php echo $year8x; ?>, <?php echo $year9x; ?>, <?php echo $year10x; ?>, <?php echo $year11x; ?>, <?php echo $year12x; ?>],
		  <?php
		  }
	  }
		  ?>
        ...
        var options = {
          title: 'Mercado <?php echo $paisname ?> - Departamento: <?=$namedepa1;?> - Evolucion Anual de Exportaciones / <?php echo $combo ?> / 2012 - 2021',
          /*curveType: 'function',
