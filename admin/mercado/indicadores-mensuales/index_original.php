...
/*sumamos valorfob*/
		   ...
		   FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode'";
...
SUM(CASE extract(MONTH from exportacion.fnum) WHEN '12' THEN exportacion.vpesbru ELSE 0 END) AS diciembre FROM exportacion where extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
...
while($fila_qunicom=$resultado_qunicom->fetch_array()){
	  ...
	  $query_parti = "SELECT Count(DISTINCT exportacion.part_nandi) as cant_parti, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
	   /*$resultado_parti = pg_query($query_parti) or die("Error en la Consulta SQL");
	  $numReg_parti = pg_num_rows($resultado_parti);
	  if($numReg_parti>0){
		  while ($fila_parti=pg_fetch_array($resultado_parti)) {*/
...
while($fila_parti=$resultado_parti->fetch_array()){
	  ...
	  $generalA = "SELECT Count(DISTINCT exportacion.part_nandi) as cant_parti FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaA = pg_query($generalA) or die("Error en la Consulta SQL");
	  $numReg_geneA = pg_num_rows($res_generaA);
	  if($numReg_geneA>0){
		  while ($fila_generaA=pg_fetch_array($res_generaA)) {*/
...
while($fila_creg=$resultado_creg->fetch_array()){
	  ...
	  /*cuenta cantidad de duas*/
	   $query_dua = "SELECT Count(DISTINCT exportacion.ndcl) as cant_dua, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_dua=$resultado_dua->fetch_array()){
	  ...
	  $generalB = "SELECT Count(DISTINCT exportacion.ndcl) as cant_dua FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaB = pg_query($generalB) or die("Error en la Consulta SQL");
	  $numReg_geneB = pg_num_rows($res_generaB);
	  if($numReg_geneB>0){
		  while ($fila_generaB=pg_fetch_array($res_generaB)) {*/
...
while($fila_generaB=$res_generaB->fetch_array()){
	  ...
	  /*cuenta cantidad de empresas*/
	   $query_emp = "SELECT Count(DISTINCT exportacion.dnombre) as cant_nom, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_emp=$resultado_emp->fetch_array()){
	  ...
	  $generalC = "SELECT Count(DISTINCT exportacion.dnombre) as cant_nom FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
...
while($fila_generaC=$res_generaC->fetch_array()){
	 ...
	 /* $query_merca = "SELECT Count(DISTINCT exportacion.cpaides) as cant_mer, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
	  ...
	  /*contamos cantidad de puertos*/
	   $query_pue = "SELECT Count(DISTINCT exportacion.cpuedes) as cant_pue, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_pue=$resultado_pue->fetch_array()){
	  ...
	  $generalD = "SELECT Count(DISTINCT exportacion.cpuedes) as cant_pue FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaD = pg_query($generalD) or die("Error en la Consulta SQL");
	  $numReg_geneD = pg_num_rows($res_generaD);
	  if($numReg_geneD > 0){
		  while ($fila_generaD=pg_fetch_array($res_generaD)) {*/
...
while($fila_generaD=$res_generaD->fetch_array()){
	  ...
	  /*contamos cantidad de aduanas*/
	   $query_adua = "SELECT Count(DISTINCT exportacion.cadu) as cant_adua, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_adua=$resultado_adua->fetch_array()){
	  ...
	  $generalE = "SELECT Count(DISTINCT exportacion.cadu) as cant_adua FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaE = pg_query($generalE) or die("Error en la Consulta SQL");
	  $numReg_geneE = pg_num_rows($res_generaE);
	  if($numReg_geneE > 0){
		  while ($fila_generaE=pg_fetch_array($res_generaE)) {*/
...
while($fila_merca=$resultado_merca->fetch_array()){
	  ...
	  $generalF = "SELECT COUNT(DISTINCT departamento.nombre) as departamento FROM exportacion LEFT JOIN departamento ON  ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaF = pg_query($generalF) or die("Error en la Consulta SQL");
	  $numReg_geneF = pg_num_rows($res_generaF);
	  if($numReg_geneF > 0){
		  while ($fila_generaF=pg_fetch_array($res_generaF)) {*/
...
while($fila_dist=$resultado_dist->fetch_array()){
	  ...
	  $generalH = "SELECT count(DISTINCT distrito.nombre) AS distrito FROM exportacion LEFT JOIN distrito ON exportacion.ubigeo= distrito.iddistrito WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaH = pg_query($generalH) or die("Error en la Consulta SQL");
	  $numReg_geneH = pg_num_rows($res_generaH);
	  if($numReg_geneH > 0){
		  while ($fila_generaH=pg_fetch_array($res_generaH)) {*/
...
while($fila_generaH=$res_generaH->fetch_array()){
	  ...
	  /*contamnos cantidad de agente*/
	   $query_agen = "SELECT Count(DISTINCT exportacion.cage) as cant_agen, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_agen=$resultado_agen->fetch_array()){
	  ...
	  $generalI = "SELECT Count(DISTINCT exportacion.cage) as cant_agen FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaI = pg_query($generalI) or die("Error en la Consulta SQL");
	  $numReg_geneI = pg_num_rows($res_generaI);
	  if($numReg_geneI > 0){
		  while ($fila_generaI=pg_fetch_array($res_generaI)) {*/
...
while($fila_agen=$res_generaI->fetch_array()){
	  ...
	  /*contamos cantidad via de transporte*/
	   $query_via = "SELECT Count(DISTINCT exportacion.cviatra) as cant_via, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' GROUP BY mes order BY mes ASC";
...
while($fila_via=$resultado_via->fetch_array()){
	  ...
	  $generalJ = "SELECT Count(DISTINCT exportacion.cviatra) as cant_via FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod' AND exportacion.cpaides='$paiscode' ";
	  /*$res_generaJ = pg_query($generalJ) or die("Error en la Consulta SQL");
	  $numReg_geneJ = pg_num_rows($res_generaJ);
	  if($numReg_geneJ > 0){
		  while ($fila_generaJ=pg_fetch_array($res_generaJ)) {*/
