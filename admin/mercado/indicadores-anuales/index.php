...
set_time_limit(500);
$paisname = $_POST["namepaisA"];
$paiscode = $_POST["codepaisA"];

$namedepa1 = $_POST["namedepa"];
$ubicod1 = $_POST["codubi"];
if($ubicod1!=""){
	$flatcod = $ubicod1;
	//$queryx = "AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod'";
	$queryx = "AND SUBSTRING(exportacion.ubigeo,1,2) = '$flatcod'";
}else{
	$flatcod = "";
	$queryx = "";
}
...
extract(year from exportacion.fnum) <= '2021' $queryx AND exportacion.cpaides ='".$paiscode."'";
...
extract(year from exportacion.fnum) <= '2021' $queryx AND exportacion.cpaides ='".$paiscode."' GROUP BY anio order BY anio ASC";
...
extract(year from exportacion.fnum) <= '2018' AND exportacion.cpaides ='".$empresa."' GROUP BY anio order BY anio ASC";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Analisis Mercado Indicador Anual - Exportaciones </b><br> Mercado: $paisname │ Departamento: $namedepa1 │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
         ...
         ['2014',  <?php echo $vfob_2014 ?>, <?php echo $vpes_2014 ?>, <?php echo $qunicom_2013 ?>, <?php echo $vbru_2014 ?>, <?php echo $preciofob2014 ?>, <?php echo $qunifis_2014 ?>],
         ['2015',  <?php echo $vfob_2015 ?>, <?php echo $vpes_2015,2 ?>, <?php echo $qunicom_2013 ?>, <?php echo $vbru_2015 ?>, <?php echo $preciofob2015 ?>, <?php echo $qunifis_2015 ?>],
         ['2016',  <?php echo $vfob_2016 ?>, <?php echo $vpes_2016 ?>, <?php echo $qunicom_2013 ?>, <?php echo $vbru_2016 ?>, <?php echo $preciofob2016 ?>, <?php echo $qunifis_2016 ?>],
    ...
    var options = {
      title : 'Reporte Analisis Mercado Anual <?php echo $paisname ?> - Exportaciones - Departamento: <?=$namedepa1;?> - Periodo 2012 - 2021',
      vAxis: {title: 'Cups'},
      hAxis: {title: 'Years'},
      seriesType: 'bars',
      series: {6: {type: 'line'}}
