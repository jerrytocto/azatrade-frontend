...
set_time_limit(750);
$paisname = $_POST["namepaisR"];
$paiscode = $_POST["codepaisR"];
...
exportacion
GROUP BY
ax2012, ax2013, ax2014, ax2015, ax2016, ax2017, ax2018, ax2019";
/*$res_totalfob = pg_query($total_suma) or die("Error en la Consulta SQL fob2012");
	  $numReg_totalfob = pg_num_rows($res_totalfob);
	  if($numReg_totalfob>0){
		  while ($fila_tofob=pg_fetch_array($res_totalfob)) {*/
...
while($fila_tofob=$res_totalfob->fetch_array()){
 ...
 /*$res_depa2012 = pg_query($totaldepa2012) or die("Error en la Consulta SQL depa2012");
	  $numReg_depa2012 = pg_num_rows($res_depa2012);
	  if($numReg_depa2012>0){
		  while ($fila_depa12=pg_fetch_array($res_depa2012)) {*/
...
$totaldepa2013="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2013'";
 /*$res_depa2013 = pg_query($totaldepa2013) or die("Error en la Consulta SQL depa2013");
	  $numReg_depa2013 = pg_num_rows($res_depa2013);
	  if($numReg_depa2013>0){
		  while ($fila_depa13=pg_fetch_array($res_depa2013)) {*/
...
$totaldepa2014="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2014'";
 /*$res_depa2014 = pg_query($totaldepa2014) or die("Error en la Consulta SQL depa2014");
	  $numReg_depa2014 = pg_num_rows($res_depa2014);
	  if($numReg_depa2014>0){
		  while ($fila_depa14=pg_fetch_array($res_depa2014)) {*/
...
$totaldepa2015="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2015'";
 /*$res_depa2015 = pg_query($totaldepa2015) or die("Error en la Consulta SQL depa2015");
	  $numReg_depa2015 = pg_num_rows($res_depa2015);
	  if($numReg_depa2015>0){
		  while ($fila_depa15=pg_fetch_array($res_depa2015)) {*/
...
$totaldepa2016="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2016'";
 /*$res_depa2016 = pg_query($totaldepa2016) or die("Error en la Consulta SQL depa2016");
	  $numReg_depa2016 = pg_num_rows($res_depa2016);
	  if($numReg_depa2016>0){
		  while ($fila_depa16=pg_fetch_array($res_depa2016)) {*/
...
$totaldepa2017="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2017'";
 /*$res_depa2017 = pg_query($totaldepa2017) or die("Error en la Consulta SQL depa2017");
	  $numReg_depa2017 = pg_num_rows($res_depa2017);
	  if($numReg_depa2017>0){
		  while ($fila_depa17=pg_fetch_array($res_depa2017)) {*/
...
$totaldepa2018="SELECT DISTINCT ee.part_nandi, ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2018'";
 /*$res_depa2018 = pg_query($totaldepa2018) or die("Error en la Consulta SQL depa2018");
	  $numReg_depa2018 = pg_num_rows($res_depa2018);
	  if($numReg_depa2018>0){
		  while ($fila_depa18=pg_fetch_array($res_depa2018)) {*/
...
while($fila_depa19=$res_depa2019->fetch_array()){
 ...
 if($nombres2=="depa"){
 $totaldepa2012="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2012'";
 /*$res_depa2012 = pg_query($totaldepa2012) or die("Error en la Consulta SQL depa2012");
	  $numReg_depa2012 = pg_num_rows($res_depa2012);
	  if($numReg_depa2012>0){
		  while ($fila_depa12=pg_fetch_array($res_depa2012)) {*/
...
$totaldepa2013="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2013'";
 /*$res_depa2013 = pg_query($totaldepa2013) or die("Error en la Consulta SQL depa2013");
	  $numReg_depa2013 = pg_num_rows($res_depa2013);
	  if($numReg_depa2013>0){
		  while ($fila_depa13=pg_fetch_array($res_depa2013)) {*/
...
$totaldepa2014="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2014'";
 /*$res_depa2014 = pg_query($totaldepa2014) or die("Error en la Consulta SQL depa2014");
	  $numReg_depa2014 = pg_num_rows($res_depa2014);
	  if($numReg_depa2014>0){
		  while ($fila_depa14=pg_fetch_array($res_depa2014)) {*/
...
$totaldepa2015="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2015'";
 /*$res_depa2015 = pg_query($totaldepa2015) or die("Error en la Consulta SQL depa2015");
	  $numReg_depa2015 = pg_num_rows($res_depa2015);
	  if($numReg_depa2015>0){
		  while ($fila_depa15=pg_fetch_array($res_depa2015)) {*/
...
$totaldepa2016="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2016'";
 /*$res_depa2016 = pg_query($totaldepa2016) or die("Error en la Consulta SQL depa2016");
	  $numReg_depa2016 = pg_num_rows($res_depa2016);
	  if($numReg_depa2016>0){
		  while ($fila_depa16=pg_fetch_array($res_depa2016)) {*/
...
$totaldepa2017="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2017'";
 /*$res_depa2017 = pg_query($totaldepa2017) or die("Error en la Consulta SQL depa2017");
	  $numReg_depa2017 = pg_num_rows($res_depa2017);
	  if($numReg_depa2017>0){
		  while ($fila_depa17=pg_fetch_array($res_depa2017)) {*/
...
$totaldepa2018="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2018'";
 /*$res_depa2018 = pg_query($totaldepa2018) or die("Error en la Consulta SQL depa2018");
	  $numReg_depa2018 = pg_num_rows($res_depa2018);
	  if($numReg_depa2018>0){
		  while ($fila_depa18=pg_fetch_array($res_depa2018)) {*/
...
$totaldepa2019="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2019'";
	 $res_depa2019=$conexpg->query($totaldepa2019); 
if($res_depa2019->num_rows>0){ 
while($fila_depa19=$res_depa2019->fetch_array()){
			  $sumatotal2019 = $sumatotal2019 + 1;
	...
	$query1 = "SELECT e.cpaides FROM exportacion AS e GROUP BY e.cpaides ORDER BY e.cpaides ASC";
...
if($resultado1->num_rows>0){ 
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Resumen Anual de Indicadores</b><br> Mercados #: Todos │ Fecha Numeracion │ $combo │ Periodo 2012 - 2019 </b> </h4>
            </div>";
		...
		echo"<thead>
		 ...
		 echo"<tfoot>
		  ...
		  //while ($fila1=pg_fetch_array($resultado1)) {
			  ...
			  $cod_pais = $fila1['cpaides'];
			  
			  /*consultamos la descripcion del pais*/
			  $query_pais="SELECT pa.espanol FROM paises AS pa WHERE pa.idpaises = '$cod_pais'";
			  /*$res_pais = pg_query($query_pais) or die("Error en la Consulta SQL PAIS");
	  $numReg_pais = pg_num_rows($res_pais);
	  if($numReg_pais>0){
		  while ($fila_pais=pg_fetch_array($res_pais)) {*/
				  $res_pais=$conexpg->query($query_pais); 
if($res_pais->num_rows>0){ 
while($fila_pais=$res_pais->fetch_array()){
			  $nom_pais = $fila_pais['espanol'];
		  }
	  }else{
		  $nom_pais ="---";
	  }
		   ...
		   if($nombres2=="vfobserdol"){
	  $query_fob2012="SELECT
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2012' GROUP BY YEAR(ee.fnum)) as a2012,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2013' GROUP BY YEAR(ee.fnum)) as a2013,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2014' GROUP BY YEAR(ee.fnum)) as a2014,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2015' GROUP BY YEAR(ee.fnum)) as a2015,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2016' GROUP BY YEAR(ee.fnum)) as a2016,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2017' GROUP BY YEAR(ee.fnum)) as a2017,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2018' GROUP BY YEAR(ee.fnum)) as a2018,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2019' GROUP BY YEAR(ee.fnum)) as a2019
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
GROUP BY
YEAR(exportacion.fnum)";
			  /*$res_fob2012 = pg_query($query_fob2012) or die("Error en la Consulta SQL fob2012");
	  $numReg_fob2012 = pg_num_rows($res_fob2012);
	  if($numReg_fob2012>0){
		  while ($fila_fob2012=pg_fetch_array($res_fob2012)) {*/
...
while($fila_fob2012=$res_fob2012->fetch_array()){
  ...
  if($nombres2=="part_nandi" or $nombres2=="dnombre"){
	  $query_fob2012="SELECT
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2012') as a2012,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2013') as a2013,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2014') as a2014,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2015') as a2015,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2016') as a2016,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2017') as a2017,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2018') as a2018,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2019') as a2019
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
GROUP BY
a2012, a2013, a2014, a2015, a2016, a2017, a2018, a2019";
			  /*$res_fob2012 = pg_query($query_fob2012) or die("Error en la Consulta SQL fob2012");
	  $numReg_fob2012 = pg_num_rows($res_fob2012);
	  if($numReg_fob2012>0){
		  while ($fila_fob2012=pg_fetch_array($res_fob2012)) {*/
...
while($fila_fob2012=$res_fob2012->fetch_array()){
  ...
  if($nombres2=="depa"){
	  $query_fob2012="SELECT
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2012') as a2012,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2013') as a2013,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2014') as a2014,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2015') as a2015,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2016') as a2016,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2017') as a2017,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2018') as a2018,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2019') as a2019
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
...
while($fila_fob2012=$res_fob2012->fetch_array()){
	  ...
	  if($year8=='0' or $year8=='' or $year8==NULL){
		...
		if($sumatotal2017=='0' or $sumatotal2017=='' or $sumatotal2017==NULL){
			   $varitota="0.00";
		   }else{
		   $varitota= number_format((($sumatotal2018 / $sumatotal2017) - 1) * 100,2);
		   }
		  
		if($sumatotal2018=="0" or $sumatotal2018=="" or $sumatotal2018==NULL){
			  $var22 ="0.00";
		  }else{
...
<!--<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  ...
  /*$query1x = "SELECT e.cpaides FROM exportacion AS e GROUP BY e.cpaides ORDER BY e.cpaides ASC";
...
$cod_pais = $fila1x['cpaides'];
	  ...
	  if($numReg_pais>0){
		  ...
		  $nom_paisx ="---";
		   ...
		   if($nombres2=="vfobserdol"){
	  $query_fob2012="SELECT
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND date_part('year',ee.fnum)='2017' GROUP BY date_part('year',ee.fnum)) as a2017
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
GROUP BY
date_part('year',exportacion.fnum)";
			  $res_fob2012 = pg_query($query_fob2012) or die("Error en la Consulta SQL fob2012");
	  $numReg_fob2012 = pg_num_rows($res_fob2012);
	  if($numReg_fob2012>0){
		  while ($fila_fob2012=pg_fetch_array($res_fob2012)) {
			  $year4x = $fila_fob2012['a2017'];
  ...
  if($nombres2=="part_nandi" or $nombres2=="dnombre"){
	  $query_fob2012="SELECT
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND date_part('year',".$filtrofecha.")='2017') as a2017
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
...
a2012, a2013, a2014, a2015, a2016, a2017, a2018";
  ...
  if($nombres2=="depa"){
	  $query_fob2012="SELECT
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND date_part('year',".$filtrofecha.")='2017') as a2017
FROM
exportacion
WHERE
exportacion.cpaides = '$cod_pais'
...
a2017, ";
	  ...
	  if($year4=='0' or $year4=='' or $year4==NULL){
		  ...
		  $une = $nom_paisx.': '.$year4x;

		  ?>
         ['<?php echo $nom_paisx ?>', '<?php echo $year4x ?>'],
		  <?php
		  }
	  }*/
		?>
   ...
   var options = {};
      ...
      options['colors'] = [0x74d5e8, 0x47b0c5, 0x308393];
      options['width'] = ancho;
      options['height'] = alto;
