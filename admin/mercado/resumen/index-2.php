...
if(isset($_POST['condiciona'])){//inicia si hay datos
 ...
 if($nombres2=="vfobserdol"){
	...
	$query1 = "SELECT rp.varia_filtro, rp.codigo as cpaides, rp.descripcion, rp.anio1 AS a2012, rp.anio2 AS a2013, rp.anio3 AS a2014, rp.anio4 AS a2015, rp.anio5 AS a2016, rp.anio6 AS a2017, rp.anio7 AS a2018, rp.anio8 AS a2019, rp.anio9 AS a2020, rp.anio10 AS a2021, rp.variauno, rp.variados FROM resumen_mercados AS rp WHERE rp.varia_filtro = '$nombres2' AND rp.codigo <> 'Total'";
...
if($resultado1->num_rows>0){ 
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Resumen Anual de Indicadores</b><br> Mercados #: Todos │ Fecha Numeracion │ $combo │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
echo "<td>$cod_pais</td>";
echo "<td>
<a href='#' onclick='document.forma$pasa.submit()'>$nom_pais</a>
	<form method='post' name='forma$pasa' action='../../mercado.php' target='_blank'>
<input type='hidden' name='depavalue' value=''>
<input type='hidden' name='mercado' value='$cod_pais'>
<input type='hidden' name='btnsearchmerca' >
</form>
</td>";
...
echo "<td>$var22%</td>";
 echo "</tr>";
	...
	$query1to="SELECT rp.anio1 AS a2012, rp.anio2 AS a2013, rp.anio3 AS a2014, rp.anio4 AS a2015, rp.anio5 AS a2016, rp.anio6 AS a2017, rp.anio7 AS a2018, rp.anio8 AS a2019, rp.anio9 AS a2020, rp.anio9 AS a2021, rp.variauno, rp.variados FROM resumen_mercados AS rp WHERE rp.varia_filtro = '$nombres2' AND rp.codigo = 'Total'";
