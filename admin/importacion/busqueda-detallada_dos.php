...
$sena1 = trim($_GET['selecanios']);
$sena2 = trim($_GET['selecmes']);
$sena3 = trim($_GET['pais']);
$sena4 = trim($_GET['aduana']);
$sena5 = trim($_GET['ruce']);
$sena6 = trim($_GET['descri1']);
$sena7 = trim($_GET['partida']);
if(strlen($sena7)=='9'){
	$titupart = '0'.$sena7;
}else{
	$titupart =$sena7;
}
$sena8 = trim($_GET['nomparti']);
$txtstring = urlencode(str_replace('-', '', $sena8));
...
$(document).ready(function(){
   /*$("#enlaceajax").click(function(evento){
      ...
      $("#consultaforpro").load("consulta/consulta_filtrodos.php?codigo=<?=$sena1;?>&mes=<?=$sena2;?>&pais=<?=$sena3;?>&adua=<?=$sena4;?>&ruc=<?=$sena5;?>&desc=<?=$link6;?>&partida=<?=$sena7;?>&nomparti=<?=$txtstring;?>", function(){
...
$(document).ready(function() {
    ...
    $('#consultaforpro').load("consulta/consulta_filtrodos.php?codigo=<?=$sena1;?>&mes=<?=$sena2;?>&pais=<?=$sena3;?>&adua=<?=$sena4;?>&ruc=<?=$sena5;?>&desc=<?=$sena6;?>&partida=<?=$sena7;?>&nomparti=<?=$txtstring;?> ");//actualizas el div formacion
});
...
<div class="card ">
    ...
    <div class="card-icon">
                        ...
                        <h5 class="card-title"><b>filtros: Año:</b> <?=$sena1;?> <b>Descripcion Comercial:</b> <?=$sena6;?> <b>Partida: </b> <?=$titupart;?> - <?=$sena8;?> </h5>
                        <a class="btn btn-primary pull-right" href="busqueda-detallada_uno.php?selecanios=<?=$sena1;?>&selecmes=<?=$sena2;?>&pais=<?=$sena3;?>&aduana=<?=$sena4;?>&ruce=<?=$sena5;?>&descri1=<?=$sena6;?>">Atras</a>
    </div>
