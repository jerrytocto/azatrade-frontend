...
$sena7 = $_GET['partida'];
$sena8 = $_GET['nomparti'];
$sena9 = $_GET['paistresok'];
$sena10 = $_GET['aduatresok'];
$sena11 = $_GET['mestresok'];
...
$(document).ready(function(){
   /*$("#enlaceajax").click(function(evento){
      ...
      $("#consultaforpro").load("consulta/consulta_filtrotres.php?codigo=<?=$sena1;?>&mes=<?=$sena2;?>&pais=<?=$sena3;?>&adua=<?=$sena4;?>&ruc=<?=$sena5;?>&desc=<?=$link6;?>&partida=<?=$sena7;?>&paistres=<?=$sena9;?>&aduatres=<?=$sena10;?>&mestres=<?=$sena11;?>", function(){
  ...
  /* }); */
      ...
      <!--<script>
$(document).ready(function() {
    $('#consultaforpro').load('consulta/consulta_filtrotres.php?codigo=<?=$sena1;?>&mes=<?=$sena2;?>&pais=<?=$sena3;?>&adua=<?=$sena4;?>&ruc=<?=$sena5;?>&desc=<?=$sena6;?>&partida=<?=$sena7;?>&paistres=<?=$sena9;?>&aduatres=<?=$sena10;?>&mestres=<?=$sena11;?>');//actualizas el div formacion
});
...
<div class="card ">
    ...
    <div class="card-icon">
                        ...
                        <h5 class="card-title"><b>filtros: Año:</b> <?=$sena1;?> <b>Descripcion Comercial:</b> <?=$sena6;?> <b>Partida: </b> <?=$sena7;?> - <?=$sena8;?> <b>Pais: </b> <?=$sena9;?> <b>Aduana: </b> <?=$sena10;?> <b>Mes: </b> <?=$sena11;?>  </h5>
                        
                        <a class="btn btn-primary pull-right" href="busqueda-detallada_dos.php?selecanios=<?=$sena1;?>&selecmes=<?=$sena2;?>&pais=<?=$sena3;?>&aduana=<?=$sena4;?>&ruce=<?=$sena5;?>&descri1=<?=$sena6;?>&partida=<?=$sena7;?>&nomparti=<?=$sena8;?>">Atras</a>
    </div>
