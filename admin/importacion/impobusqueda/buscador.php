...
$nombres2 = trim($_POST['condiciona']);
...
<form method="post" action="buscador.php" >
					                    ...
					                    <input type="text" class="form-control css-input" name="condiciona" >
...
if(isset($_GET['q']) and !eregi('^ *$',$_GET['q'])){
		...
		$sqlStr = "SELECT dnombre,part_nandi,desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros,pais_orige,puer_embar,fob_dolpol,fle_dolar,seg_dolar,fech_ingsi FROM importacion WHERE concat(desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros) LIKE '%$nombres2%' AND year(fech_ingsi) = '2021' ORDER BY fob_dolpol DESC ";
		$sqlStrAux = "SELECT count(*) as total FROM importacion WHERE concat(desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros) LIKE '%$nombres2%' AND year(fech_ingsi) = '2021' ";
	}else{
		$sqlStr = "SELECT dnombre,part_nandi,desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros,pais_orige,puer_embar,fob_dolpol,fle_dolar,seg_dolar,fech_ingsi FROM importacion WHERE concat(desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros) LIKE '%$nombres2%' AND year(fech_ingsi) = '2021' ORDER BY fob_dolpol DESC ";
		$sqlStrAux = "SELECT count(*) as total FROM importacion WHERE concat(desc_comer,desc_matco,desc_usoap,desc_fopre,desc_otros) LIKE '%$nombres2%' AND year(fech_ingsi) = '2021' ";
