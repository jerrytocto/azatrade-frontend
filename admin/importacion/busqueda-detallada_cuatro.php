                                            ...
                                            <div class="col-md-5">
                                              <label>Descripci&oacute;n comercial ó Numero de partida (*) </label>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="descri1" id="descri1" class="form-control css-input"  placeholder="Nombre comercial ó Numero de partida (*) " size="35" value="<?php echo"$de1";?>" required  />
                                                </div>
                                            </div>
