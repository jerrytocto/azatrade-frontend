                            ...
                            <div class='modal-header'>
                                <button type='button' class='close' data-dismiss='modal' aria-hidden='true'><i class='material-icons'>clear</i></button>
                    				...
                    				<div class='modal-body'>
                    					...
                    					<?php //}else{ ?>
										<form method='post' action='partidados/resumen/' target='_blank'>
										<?php //} ?>
        ...
        <div class='card'>
            <div class='card-body'>
				...
				<div class='row'>
					...
					<form method='post' action='partidados/indicadores-anuales/' target='_blank'>
				...
				<form method='post' action='partidados/evolucion-mensual/' target='_blank'>
				...
				<!--<form method='post' action='partidados/mercados/' target='_blank'>
				...
				<!--<form method='post' action='partidados/departamentos/' target='_blank'>
				...
				<!--<form method='post' action='partidados/empresas/' target='_blank'>
		...
		echo"<div class='modal fade modal-mini modal-primary' id='myModalPartA' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                            ...
                            <div class='modal-header'>
                                <button type='button' class='close' data-dismiss='modal' aria-hidden='true'><i class='material-icons'>clear</i></button>
                    				...
                    				<div class='modal-body'>
                    					<p>
										<form method='post' action='partidados/indicador-mensual/' target='_blank'>
