...
<div class="card ">
    ...
    <div class="card-icon">
                        ...
                        <h4 class="card-title">Reporte de Usuarios Inscritos a la Web de Azatrade pendientes de ser aprobados</h4>
                        <p><a href="rpt-user.php"><b><i class='material-icons'>done_all</i> Regresar a la lista de usuarios</b></a></p>
                        <?php if($var=="ok"){ ?>
                        <div class="alert alert-success alert-dismissible">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Activado!</strong> Se activo correctamente, se le envio un correo al usuario con sus datos de acceso.
  </div>
   <?php } ?>
    </div>
...
//if(isset($_REQUEST['btnsearchbd']) and $siejecuta=="si"){
		...
		$sqlgral="Select * from usuario where estado='A' and very='0'";
		  ...
		  //while ($fila_uu=pg_fetch_array($res_gral)) {
		   ...
		   $dato8= $fila_uu['estado'];
			  ...
			  $dato16= $fila_uu['fecha'];
				  ...
				  if($dato17=="1"){
				  $apro ="<a href='' class='btn btn-success' style='color:#ffffff;'><i class='material-icons'>done_all</i> Aprobabado</a>";
				  }else{
					  $apro ="<a href='very_admin.php?key=$dato18' class='btn btn-warning' style='color:#ffffff;'><i class='material-icons'>done</i> Aprobar Acceso</a>";
				  }
