...
<link href="../css/demo.css?xx=2020" rel="stylesheet"/>
...
if($querypx->num_rows>0){
                          ...
                          <div class='modal-dialog'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-body'>
									...
									<p>Para ver mas detalle de esta partida, <a href='viewpartida.php?data=$partida&t=$partida&d1=' target='_blank'><button type='button' class='btn btn-info btn-link'>dale click aqui</button></a>.</p>
	...
	<center>
                            ...
                            <div class='modal-header'>
                                <button type='button' class='close' data-dismiss='modal' aria-hidden='true'><i class='material-icons'>clear</i></button>
									...
									<p align='center'><b>Indicadores Mensuales</b><br>Partida #$partida</p>	
										...
										<select name='anioim' class='form-control' data-size='7' data-style='btn btn-info btn-round' required>
                            ...
                            <div class='modal-header'>
                                <button type='button' class='close' data-dismiss='modal' aria-hidden='true'><i class='material-icons'>clear</i></button>
                    				...
                    				<p align='center'><b>Estacionalidad</b></p>
										...
										<input type='hidden' name='nomdescri' value='$bus2'>
										<b>Indicador</b><br>
										<select name='unavariaestaci' class='form-control' data-size='7' data-style='btn btn-info btn-round' required>
		...
		echo"<div class='modal fade modal-mini modal-primary' id='myModalMercaDos$itte' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
				...
				<input type='hidden' name='namedepa' value='$nomde'>
										<b>Indicador</b><br>
										<select name='unavaria' class='form-control' data-size='7' data-style='btn btn-info btn-round' required>
                <option value=''>Selecciona Indicador</option>
				<option value='vfobserdol'>Valor FOB USD</option>
				<option value='vpesnet'>Peso Neto (Kg)</option>
                <option value='diferen'>Precio FOB USD x KG</option>
