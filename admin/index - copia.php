...
<!-- End Navbar -->
      ...
      <div class="col-md-12">  
                ...
                <?php if(isset($_REQUEST['btnsearch'])){ ?>
                 <div id="carga" style="width:100%;text-align: center;">
<Center><img class="img-responsive" src="img/loading-carga.gif" width="100px"><br><p style="font-size:12px; color:#EC0D36;"> Espere un momento, la consulta puede tardar unos minutos. </p></Center>
     </div>
               <?php } ?>
                
    <p align="center">¿ Que deseas conocer de un producto ?</p>
       <!--<div class="col-md-12 col-lg-12 hidden-xs">
                            <div class="row">
    <div class="col-lg-2 col-md-6 col-sm-6">
      <?php if (isset($_SESSION['login_usuario'])){ ?>
      <a href="pagina.php?dat=<?=$cajapar;?>" target="_blank">
      <?php }else{ ?>
       <a data-toggle="modal" data-target="#myModalalertproduc">
       <?php } ?>
        <div class="card card-stats">
            ...
            <div class="card-body">
            <h4 class="card-title"><center><b>Indicadores Anuales</b></center></h4>
			</div>
        </div>
        </a>
    </div>
      ...
      <?php }else{ ?>
       ...
       <?php } ?>
        <div class="card card-stats">
            ...
            <div class="card-body">
            <h4 class="card-title"><center><b>Mercados</b></center></h4>
			</div>
        </div>
		  </a>
    </div>
      ...
      <?php }else{ ?>
       ...
       <?php } ?>
        <div class="card card-stats">
            ...
            <div class="card-body">
            <h4 class="card-title"><center><b>Empresas</b></center></h4>
			</div>
        </div>
		  </a>
    </div>
      ...
      <?php }else{ ?>
       ...
       <?php } ?>
        <div class="card card-stats">
            ...
            <div class="card-body">
            <h4 class="card-title"><center><b>Regiones</b></center></h4>
			</div>
        </div>
		  </a>
    </div>
    <div class="col-lg-2 col-md-6 col-sm-6">
      ...
      <?php }else{ ?>
       ...
       <?php } ?>
        <div class="card card-stats">
            ...
            <div class="card-body">
            <h4 class="card-title"><center><b>Resumen de Productos</b></center></h4>
			</div>
        </div>
		  </a>
    </div>
     ...
     <!-- ************** -->
        ...
        <!-- fin botones modo movil o table -->
...
anio,e.part_nandi,nomarancel";
	  ...
	  if($numReg_parti>0){
		  ...
		  while ($fila_parti=pg_fetch_array($result_parti)) {
		   ...
		   //$total_vfob= number_format($fila_parti['vfob'],2,",",".");
		   //$total_peso= number_format($fila_parti['pneto'],2,",",".");
		...
		echo "<td align='right'>$total_vfob</td>";
        echo "<td align='right'>$total_peso</td>";
        echo "<td align='right'>$preciovfob</td>";
			  
			  if (isset($_SESSION['login_usuario'])){
				  $columnaBu = "<a href='#' class='btn btn-link btn-info btn-just-icon' rel='tooltip' title='Ver Detalle'><i class='material-icons'>find_in_page</i></a>";
		...
		$columnaBu
		<a href='#' rel='tooltip' title='Ver Arancel' class='btn btn-link btn-success btn-just-icon' data-toggle='modal' data-target='#myModalarancel$itte'><i class='material-icons'>ballot</i></a>
		$columnoption
