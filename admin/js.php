...
<section class="chat-conteiner">
   ...
   <script>
	...
	<!-- div del chat messenger flotante fin-->
	<style>
	.flotante {
    display:scroll;
        position:fixed;
...
<div class="row">
    <a class='flotante' href='http://wa.me/51978037200?text=Hola%20más%20información%20sobre%20azatrade' target="_blank" ><img src='img/whatsapp-icon-logo.png' width="50px" border="0"/></a>
</div>