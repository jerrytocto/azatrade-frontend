...
if($ubicod1!=""){
	$flatcod = $ubicod1;
	$codex = "AND SUBSTRING(exportacion.ubigeo,1,2) LIKE '%$flatcod'";
}else{
	$flatcod = "";
	$codex = "";
}
...
while($fila1=$resultado_insercons->fetch_array()){
 ...
 $rs = $conexpg->query($insert1);
		   ...
		   echo"<center><h4><font color='#EC0D36'>No hay Resultados<br>El Numero de Partida $nombres es Incorrecto</font></h4></center>";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Evolucion Mensual de Exportaciones</b><br> Partida #: $partida1 │ Departamento: $namedepa1 │ Fecha Numeracion │ Valor FOB USD │ Periodo 2012 - 2019 </b> </h4>
            </div>";
...
while($fila_rptx=$resultado_rptx->fetch_array()){
		  ...
		  ?>
		  ['<?php echo $nombredescx2; ?>',  <?php echo $year3x; ?>, <?php echo $year4x; ?>, <?php echo $year4x; ?>, <?php echo $year6x; ?>, <?php echo $year7x; ?>, <?php echo $year8x; ?>, <?php echo $year9x; ?>, <?php echo $year10x; ?>],
		  <?php
		  }
	  }
		  ?>
        ...
        var options = {
          title: 'Partida: <?php echo $partida1 ?> / Departamento: <?=$namedepa1;?> / Evolucion Mensual de Exportaciones / Valor FOB USD / Periodo: 2012 - 2019',
          /*curveType: 'function',
