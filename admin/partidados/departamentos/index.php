...
WHERE exportacion.part_nandi = ".$partida1." $codex 
...
if($filtro=="vfobserdol"){
//$query1 = "SELECT extract(YEAR from exportacion.fnum) AS anio, substring(exportacion.ubigeo,1,2) as ubi1, departamento.nombre, Sum(exportacion.vfobserdol) AS resultado FROM exportacion LEFT JOIN departamento ON   ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(YEAR from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2019' GROUP BY anio,departamento.nombre,ubi1 ORDER BY anio,nombre ASC";
$query1 = "SELECT extract(YEAR from exportacion.fnum) AS anio, substring(exportacion.ubigeo,1,2) as ubi1, '' as nombre, Sum(exportacion.vfobserdol) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(YEAR from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2019' GROUP BY anio,nombre,ubi1 ORDER BY anio,nombre ASC";
}
if($filtro=="vpesnet"){
$query1 = "SELECT extract(YEAR from exportacion.fnum) AS anio, substring(exportacion.ubigeo,1,2) as ubi1, '' as nombre, Sum(exportacion.vpesnet) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(YEAR from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2019' GROUP BY anio,nombre,ubi1 ORDER BY anio,nombre ASC";
}
if($filtro=="diferen"){
	$query1 = "SELECT extract(YEAR from exportacion.fnum) AS anio, substring(exportacion.ubigeo,1,2) as ubi1, '' as nombre, (exportacion.vfobserdol/exportacion.vpesnet) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(YEAR from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2019' GROUP BY anio,nombre,ubi1 ORDER BY anio,nombre ASC";
}
...
if($resultado1!=0){//inicia si hay resultados
	if($filtro=="vfobserdol"){
	$queryr = "SELECT extract(YEAR from exportacion.fnum) AS anio, Sum(exportacion.vfobserdol) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(year from exportacion.fnum) = '2018' GROUP BY anio order BY anio ASC";
	}
	if($filtro=="vpesnet"){
		$queryr = "SELECT extract(YEAR from exportacion.fnum) AS anio, Sum(exportacion.vpesnet) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(year from exportacion.fnum) = '2018' GROUP BY anio order BY anio ASC";
	}
	if($filtro=="diferen"){
		$queryr = "SELECT extract(YEAR from exportacion.fnum) AS anio, (exportacion.vfobserdol/exportacion.vpesnet) AS resultado FROM exportacion WHERE exportacion.part_nandi = ".$partida1." $codex AND extract(year from exportacion.fnum) = '2018' GROUP BY anio order BY anio ASC";
	}
...
if($resultado_rpt->num_rows>0){ 
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte de Ubigeo Anual de Exportaciones</b><br> Partida #: $partida1 │ Departamento: $namedepa1 │ Fecha Numeracion │ $nomfiltro │ Periodo 2012 - 2019 </b> </h4>
            </div>";
...
while($fila_ma=$mapa_rpt->fetch_array()){
        ...
        <center>
        <h3 class="title" id="mapa"><font color="#FFFFFF">Mapa Geografico │ Partida <?=$partida1;?> │ Departamento: <?=$namedepa1;?> │ Ubigeo Anual de Exportaciones │ <?=$nomfiltro;?> │ Periodo 2018</font></h3></center>
