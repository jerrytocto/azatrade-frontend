...
exportacion
GROUP BY
ax2012, ax2013, ax2014, ax2015, ax2016, ax2017, ax2018, ax2019, ax2020";
...
while($fila_depa19=$res_depa2019->fetch_array()){
	  ...
	  $totaldepa2020="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2020'";
	 $res_depa2020=$conexpg->query($totaldepa2020); 
if($res_depa2020->num_rows>0){ 
while($fila_depa20=$res_depa2020->fetch_array()){
			  $sumatotal2020 = $sumatotal2020 + 1;
	 ...
	 $totaldepa2021="SELECT DISTINCT substring(ee.ubigeo,1,2), ee.cpaides FROM exportacion ee WHERE YEAR(ee.fnum)='2021'";
	 $res_depa2021=$conexpg->query($totaldepa2021); 
if($res_depa2021->num_rows>0){ 
while($fila_depa21=$res_depa2021->fetch_array()){
			  $sumatotal2021 = $sumatotal2021 + 1;
	...
	echo"<div class='card-header card-header-info card-header-icon'>
		...
		echo"<thead>
		 ...
		 echo"<tfoot>
           ...
           echo"<tbody>";*/
	//eliminamos registro
				  $Sqldelmerc="DELETE FROM resumen_mercados WHERE varia_filtro ='$nombres2' ";
				  $rs = $conexpg->query($Sqldelmerc);
...
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2020' GROUP BY YEAR(ee.fnum)) as a2020,
(SELECT Sum(ee.vfobserdol) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(ee.fnum)='2021' GROUP BY YEAR(ee.fnum)) as a2021
FROM exportacion
WHERE exportacion.cpaides = '$cod_pais'
GROUP BY YEAR(exportacion.fnum)";
...
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2020') as a2020,
(SELECT COUNT(DISTINCT ee.".$nombres2.") FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2021') as a2021
FROM exportacion
WHERE exportacion.cpaides = '$cod_pais'
GROUP BY a2012, a2013, a2014, a2015, a2016, a2017, a2018, a2019, a2020, a2021";
	  $res_fob2012=$conexpg->query($query_fob2012); 
if($res_fob2012->num_rows>0){ 
while($fila_fob2012=$res_fob2012->fetch_array()){
			  $year1 = $fila_fob2012['a2012'];
...
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2020') as a2020,
(SELECT COUNT(DISTINCT substring(ee.ubigeo,1,2)) FROM exportacion ee WHERE ee.cpaides = '$cod_pais' AND YEAR(".$filtrofecha.")='2021') as a2021
FROM exportacion
WHERE exportacion.cpaides = '$cod_pais'
GROUP BY
a2012, a2013, a2014, a2015, a2016, a2017, a2018, a2019, a2020, a2021";
	  $res_fob2012=$conexpg->query($query_fob2012); 
if($res_fob2012->num_rows>0){ 
while($fila_fob2012=$res_fob2012->fetch_array()){
			  $year1 = $fila_fob2012['a2012'];
...
echo "<td>$var22%</td>";
 echo "</tr>";*/
				  ...
				  $Sql_insermerca="insert into resumen_mercados (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, anio9, anio10, variauno, variados
)  values (
'$nombres2',
'$cod_pais',
'$nom_pais',
...
'$var11',
'$var22' )";
	$rscrea2 = $conexpg->query($Sql_insermerca);
	...
	$Sql_insermercatota="insert into resumen_mercados (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, anio9, anio10, variauno, variados
)  values (
'$nombres2',
'Total',
'Totales',
...
'$varitota',
'$parti' )";
	$rscreatota = $conexpg->query($Sql_insermercatota);
...
echo"<script>location.href='resumen_procesa.php?by=ok&val=Mercados&fit=$combo'</script>";
?>
</html>