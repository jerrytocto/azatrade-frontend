...
while($fila_merca=$resultado_merca->fetch_array()){
	...
	/*total general de mercados*/
	  $generalC = "SELECT Count(DISTINCT exportacion.cpaides) as cant_mer FROM exportacion INNER JOIN sector ON sector.partida = exportacion.part_nandi WHERE extract(year from exportacion.fnum) = '$anio' $query1 AND concat(sector.tipo,sector.sector)='$codeid' ";
				$res_generaC=$conexpg->query($generalC); 
if($res_generaC->num_rows>0){ 
while($fila_generaC=$res_generaC->fetch_array()){
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Analisis Sectores Indicador Mensual - Exportaciones </b><br> Sector: $namesector │ Departamento: $namedepa1 │ Fecha Numeracion │ Periodo $anio </b> </h4>
            </div>";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            title: 'Reporte Analisis Sector Mensual <?php echo $namesector ?> - Departamento: <?=$namedepa1;?> - Exportaciones',
