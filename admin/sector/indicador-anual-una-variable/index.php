...
if($ubicod1!=""){
	$flatcod = $ubicod1;
	//$querybusca = "AND SUBSTRING(exportacion.ubigeo,1,2) like '%$flatcod'";
...
$rangofe = "extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021'";
...
while($fila_year=$result_year->fetch_array()){
		...
		if($sumatotal2012=='0'){
			 ...
			 if($sumatotal2018=='0' or $sumatotal2018 == null){
			  ...
			  $varitota= number_format((($sumatotal2020 / $sumatotal2019) - 1) * 100,2);
			  $parti= number_format(($ca1_9x + $ca2_9x + $ca3_9x + $ca4_9x + $ca5_9x + $ca6_9x + $ca8_9x )/8,2) ;
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Sector Evolucion Anual de Exportaciones</b><br> Sector: $namesector │ Departamento: $namedepa1 │ Variable: $combo │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
while($fila_rptx=$resultado_rptx->fetch_array()){
	...
	$year12x= $fila_rptx['a2021'];
        ...
        var options = {
          title: 'Sector <?php echo $namesector ?> - Departamento: <?=$namedepa1;?> - Evolucion Anual de Exportaciones / <?php echo $combo ?> / 2012 - 2021',
          /*curveType: 'function',
