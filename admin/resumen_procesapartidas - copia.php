...
while($fila_year=$result_year->fetch_array()){
		   ...
		   $varitota= (($sumatotal2018 / $sumatotal2017) - 1) * 100;
		   }
		   $parti='100 %';
		   }
	  }else{
...
if($resultado1->num_rows>0){ 
	...
	//echo "$nombres2 <br>";
		...
		if($year6=='0'){
		  ...
		  $var11 = (($year7 / $year6) - 1) * 100;
		  }
		  
		if($sumatotal2018=="0"){
			  $var22 ="0.00";
		  }else{
		  $var22 = ($year7 / $sumatotal2018) * 100;
		  }
...
echo "<td>$var22%</td>";
 echo "</tr>";*/
				  ...
				  $uno8 = $year8;
				  //insertamos detalle
				$Sql_inserparti="insert into resumen_partidas (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, variauno, variados
)  values (
'$nombres2',
'$cod_part',
'$nom_parti',
...
'$var11',
'$var22' )";
	$rscrea2 = $conexpg->query($Sql_inserparti);
	...
	$Sql_inserpartitota="insert into resumen_partidas (varia_filtro, codigo, descripcion, anio1, anio2, anio3, anio4, anio5, anio6, anio7, anio8, variauno, variados
)  values (
'$nombres2',
'Total',
'Totales',
...
'$varitota',
'$parti' )";
	$rscreatota = $conexpg->query($Sql_inserpartitota);
