...
set_time_limit(250);
$paisname = $_POST["namempA"];
$paiscode = $_POST["codempA"];
...
extract(year from exportacion.fnum) <= '2021' $querye '%$flatcod' AND exportacion.ndoc ='".$paiscode."'";
...
while($fila_vfob=$resultado_vfob->fetch_array()){ 
	...
	$vfob_2021= "0.00";
	  ...
	  /* sumamos vpesnet*/
	   ...
	   FROM exportacion where extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' $querye AND exportacion.ndoc ='".$paiscode."'";
...
$var3= number_format((($vpes_2020/$vpes_2019) - 1) * 100,2);
			  ...
			  if($vpes_2012=='0' or $vpes_2012=='' or $vpes_2012== isnull){
			  $ca1x ='0';
		      }else{
		      $ca1x = (($vpes_2013 / $vpes_2012) - 1) * 100;
		      }
			   if($vpes_2013=='0' or $vpes_2013=='' or $vpes_2013==isnull){
			  $ca2x ='0';
		      }else{
		      $ca2x = (($vpes_2014 / $vpes_2013) - 1) * 100;
		      }
			   if($vpes_2014=='0' or $vpes_2014=='' or $vpes_2014== isnull){
			  $ca3x ='0';
		      }else{
		      $ca3x = (($vpes_2015 / $vpes_2014) - 1) * 100;
		      }
			   if($vpes_2015=='0' or $vpes_2015=='' or $vpes_2015== isnull){
			  $ca4x ='0';
		      }else{
		      $ca4x = (($vpes_2016 / $vpes_2015) - 1) * 100;
		      }
			 if($vpes_2016=='0' or $vpes_2016=='' or $vpes_2016== isnull){
			  $ca5x ='0';
		      }else{
		      $ca5x = (($vpes_2017 / $vpes_2016) - 1) * 100;
		      }
			  if($vpes_2017=='0' or $vpes_2017=='' or $vpes_2017== isnull){
			  $ca6x ='0';
		      }else{
		      $ca6x = (($vpes_2018 / $vpes_2017) - 1) * 100;
		      }
			  if($vpes_2018=='0' or $vpes_2018=='' or $vpes_2018== isnull){
			  $ca7x ='0';
		      }else{
		      $ca7x = (($vpes_2019 / $vpes_2018) - 1) * 100;
		      }
	if($vpes_2019=='0' or $vpes_2019=='' or $vpes_2019== isnull){
			  $ca8x ='0';
		      }else{
		      $ca8x = (($vpes_2020 / $vpes_2019) - 1) * 100;
		      }
	if($vpes_2020=='0' or $vpes_2020=='' or $vpes_2020== isnull){
			  $ca9x ='0';
		      }else{
	...
	$vpes_2021= "0.00";
		...
		$preciofob2020 = $vfob_2020/ $vpes_2020;
				...
				if($vpes_2021=='0' or $vpes_2021=='' or $vpes_2021== isnull){
		$preciofob2021 = "0.00";
		}else{
		...
		if($preciofob2012=='0'){
		      ...
		      $ca4_1 = (($preciofob2016 / $preciofob2015) - 1) * 100;
			   ...
			   if($preciofob2016=='0' or $preciofob2016==null){
			  $ca5_1 ='0';
		      }else{
		      $ca5_1 = (($preciofob2017 / $preciofob2016) - 1) * 100;
		      }
			  if($preciofob2017=='0' or $preciofob2017==null){
			  $ca6_1 ='0';
		      }else{
		      $ca6_1 = (($preciofob2018 / $preciofob2017) - 1) * 100;
		      }
				if($preciofob2018=='0' or $preciofob2018==null){
			  $ca7_1 ='0';
		      }else{
		      $ca7_1 = (($preciofob2019 / $preciofob2018) - 1) * 100;
		      }
				if($preciofob2019=='0' or $preciofob2019==null){
			  $ca8_1 ='0';
		      }else{
		      $ca8_1 = (($preciofob2020 / $preciofob2019) - 1) * 100;
		      }
				if($preciofob2020=='0' or $preciofob2020==null){
			  $ca9_1 ='0';
		      }else{
...
$var7= number_format((($vbru_2020/$vbru_2019) - 1) * 100,2);
			  ...
			  if($vbru_2012=='0' or $vbru_2012==null){
			  $ca1_x ='0';
		      }else{
		      $ca1_x = (($vbru_2013 / $vbru_2012) - 1) * 100;
		      }
			   if($vbru_2013=='0' or $vbru_2013==null){
			  $ca2_x ='0';
		      }else{
		      $ca2_x = (($vbru_2014 / $vbru_2013) - 1) * 100;
		      }
			   if($vbru_2014=='0' or $vbru_2014==null){
			  $ca3_x ='0';
		      }else{
		      $ca3_x = (($vbru_2015 / $vbru_2014) - 1) * 100;
		      }
			   if($vbru_2015=='0' or $vbru_2015==null){
			  $ca4_x ='0';
		      }else{
		      $ca4_x = (($vbru_2016 / $vbru_2015) - 1) * 100;
		      }
			 if($vbru_2016=='0' or $vbru_2016==null){
			  $ca5_x ='0';
		      }else{
		      $ca5_x = (($vbru_2017 / $vbru_2016) - 1) * 100;
		      }
			  if($vbru_2017=='0' or $vbru_2017==null){
			  $ca6_x ='0';
		      }else{
		      $ca6_x = (($vbru_2018 / $vbru_2017) - 1) * 100;
		      }
			  if($vbru_2018=='0' or $vbru_2018==null){
			  $ca7_x ='0';
		      }else{
		      $ca7_x = (($vbru_2019 / $vbru_2018) - 1) * 100;
		      }
	if($vbru_2019=='0' or $vbru_2019==null){
			  $ca8_x ='0';
		      }else{
		      $ca8_x = (($vbru_2020 / $vbru_2019) - 1) * 100;
		      }
	if($vbru_2020=='0' or $vbru_2020==null){
			  $ca9_x ='0';
		      }else{
...
$var9= number_format((($qunifis_2020/$qunifis_2020) - 1) * 100,2);
			   }

              if($qunifis_2012=='0' or $qunifis_2012==null){
			  $ca1_2 ='0';
		      }else{
		      $ca1_2 = (($qunifis_2013 / $qunifis_2012) - 1) * 100;
		      }
			   if($qunifis_2013=='0' or $qunifis_2013==null){
			  $ca2_2 ='0';
		      }else{
		      $ca2_2 = (($qunifis_2014 / $qunifis_2013) - 1) * 100;
		      }
			   if($qunifis_2014=='0' or $qunifis_2014==null){
			  $ca3_2 ='0';
		      }else{
		      $ca3_2 = (($qunifis_2015 / $qunifis_2014) - 1) * 100;
		      }
			   if($qunifis_2015=='0' or $qunifis_2015==null){
			  $ca4_2 ='0';
		      }else{
		      $ca4_2 = (($qunifis_2016 / $qunifis_2015) - 1) * 100;
		      }
			 if($qunifis_2016=='0' or $qunifis_2016==null){
			  $ca5_2 ='0';
		      }else{
		      $ca5_2 = (($qunifis_2017 / $qunifis_2016) - 1) * 100;
		      }
			  if($qunifis_2017=='0' or $qunifis_2017==null){
			  $ca6_2 ='0';
		      }else{
		      $ca6_2 = (($qunifis_2018 / $qunifis_2017) - 1) * 100;
		      }
			  if($qunifis_2018=='0' or $qunifis_2018==null){
			  $ca7_2 ='0';
		      }else{
		      $ca7_2 = (($qunifis_2019 / $qunifis_2018) - 1) * 100;
		      }
	if($qunifis_2019=='0' or $qunifis_2019==null){
			  $ca8_2 ='0';
		      }else{
		      $ca8_2 = (($qunifis_2020 / $qunifis_2019) - 1) * 100;
		      }
	if($qunifis_2020=='0' or $qunifis_2020==null){
			  $ca9_2 ='0';
		      }else{
...
while($fila_qunicom=$resultado_qunicom->fetch_array()){
	...
	$qunicom_2021= $fila_qunicom['quni2021'];
              ...
              if($qunicom_2012=='0' or $qunicom_2012==null){
			  $ca1_3 ='0';
		      }else{
		      $ca1_3 = (($qunicom_2013 / $qunicom_2012) - 1) * 100;
		      }
			   if($qunicom_2013=='0' or $qunicom_2013==null){
			  $ca2_3 ='0';
		      }else{
		      $ca2_3 = (($qunicom_2014 / $qunicom_2013) - 1) * 100;
		      }
			   if($qunicom_2014=='0' or $qunicom_2014==null){
			  $ca3_3 ='0';
		      }else{
		      $ca3_3 = (($qunicom_2015 / $qunicom_2014) - 1) * 100;
		      }
			   if($qunicom_2015=='0' or $qunicom_2015==null){
			  $ca4_3 ='0';
		      }else{
		      $ca4_3 = (($qunicom_2016 / $qunicom_2015) - 1) * 100;
		      }
			 if($qunicom_2016=='0' or $qunicom_2016==null){
			  $ca5_3 ='0';
		      }else{
		      $ca5_3 = (($qunicom_2017 / $qunicom_2016) - 1) * 100;
		      }
			  if($qunicom_2017=='0' or $qunicom_2017==null){
			  $ca6_3 ='0';
		      }else{
		      $ca6_3 = (($qunicom_2018 / $qunicom_2017) - 1) * 100;
		      }
			  if($qunicom_2018=='0' or $qunicom_2018==null){
			  $ca7_3 ='0';
		      }else{
		      $ca7_3 = (($qunicom_2019 / $qunicom_2018) - 1) * 100;
		      }
	if($qunicom_2019=='0' or $qunicom_2019==null){
			  $ca8_3 ='0';
		      }else{
		      $ca8_3 = (($qunicom_2019 / $qunicom_2018) - 1) * 100;
		      }
	if($qunicom_2020=='0' or $qunicom_2020==null){
			  $ca9_3 ='0';
		      }else{
...
while($fila_creg=$resultado_creg->fetch_array()){
	...
	$creg_2021= $fila_creg['cr2021'];
              ...
              if($creg_2012=='0' or $creg_2012==null){
			  $ca1_4 ='0.00';
		      }else{
		      $ca1_4 = (($creg_2013 / $creg_2012) - 1) * 100;
		      }
			   if($creg_2013=='0' or $creg_2013==null){
			  $ca2_4 ='0.00';
		      }else{
		      $ca2_4 = (($creg_2014 / $creg_2013) - 1) * 100;
		      }
			   if($creg_2014=='0' or $creg_2014==null){
			  $ca3_4 ='0.00';
		      }else{
		      $ca3_4 = (($creg_2015 / $creg_2014) - 1) * 100;
		      }
			   if($creg_2015=='0' or $creg_2015==null){
			  $ca4_4 ='0.00';
		      }else{
		      $ca4_4 = (($creg_2016 / $creg_2015) - 1) * 100;
		      }
			 if($creg_2016=='0' or $creg_2016== null){
			  $ca5_4 ='0.00';
		      }else{
		      $ca5_4 = (($creg_2017 / $creg_2016) - 1) * 100;
		      }
			  if($creg_2017=='0' or $creg_2017== null){
			  $ca6_4 ='0.00';
		      }else{
		      $ca6_4 = (($creg_2018 / $creg_2017) - 1) * 100;
		      }
			  if($creg_2018=='0' or $creg_2018== null){
			  $ca7_4 ='0.00';
		      }else{
		      $ca7_4 = (($creg_2019 / $creg_2018) - 1) * 100;
		      }
			  if($creg_2019=='0' or $creg_2019== null){
			  $ca8_4 ='0.00';
		      }else{
		      $ca8_4 = (($creg_2020 / $creg_2019) - 1) * 100;
		      }
	if($creg_2020=='0' or $creg_2020== null){
			  $ca9_4 ='0.00';
		      }else{
	...
	$creg_2021= "0.00";
	  ...
	  $query_parti = "SELECT Count(DISTINCT exportacion.part_nandi) as cant_parti, extract(year from exportacion.fnum) as anio FROM exportacion WHERE extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' $querye AND exportacion.ndoc ='".$paiscode."' GROUP BY anio order BY anio ASC";
...
while($fila_dua=$resultado_dua->fetch_array()){
	...
	if($rdua2019=='0' or $rdua2019 == null){
		      ...
		      $ca8_5 = (($rdua2019 / $rdua2018) - 1) * 100;
		      }
	if($rdua2020=='0' or $rdua2020 == null){
			  $ca9_5 ='0';
		      }else{
		      $ca9_5 = (($rdua2020 / $rdua2019) - 1) * 100;
		      }
...
extract(year from exportacion.fnum) <= '2018' AND exportacion.ndoc ='".$paiscode."' GROUP BY anio order BY anio ASC";
	  ...
	  if($numReg_emp>0){
		  ...
		  if($remp2016=='0'  or $remp2016 == null){
		   ...
		   $var17= number_format((($remp2017/$remp2016) - 1) * 100,2);
		   }
			 ...
			 if($remp2017=='0' or $remp2017 == null){
			  ...
			  $var18= number_format(($ca1_6 + $ca2_6 + $ca3_6 + $ca4_6 + $ca5_6)/5,2) ;
		  ...
		  if($rmer2019=='0'  or $rmer2019 == null){
		   ...
		   $var19= number_format((($rmer2020/$rmer2019) - 1) * 100,2);
			 ...
			 if($rmer2019=='0' or $rmer2019 == null){
		      ...
		      $ca8_7 = (($rmer2019 / $rmer2018) - 1) * 100;
		      }
	if($rmer2020=='0' or $rmer2020 == null){
			  $ca9_7 ='0';
		      }else{
		      $ca9_7 = (($rmer2020 / $rmer2019) - 1) * 100;
		      }
...
while($fila_adua=$resultado_adua->fetch_array()){
		  ...
		  if($radua2019=='0'  or $radua2019 == null){
		   ...
		   $var23= number_format((($radua2020/$radua2019) - 1) * 100,2);
			 ...
			 if($radua2019=='0' or $radua2019 == null){
		      ...
		      $ca8_8 = (($radua2019 / $radua2018) - 1) * 100;
		      }
	...
	$radua2021= "0.00";
	  ...
	  /*contamnos cantidad de departamento*/
	   $query_empresa = "SELECT COUNT(DISTINCT departamento.nombre) as departamento, extract(year from exportacion.fnum) as anio FROM exportacion LEFT JOIN departamento ON  ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) WHERE extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021' $querye AND exportacion.ndoc='".$paiscode."' GROUP BY anio ORDER BY anio ASC";
				$resultado_empresa=$conexpg->query($query_empresa); 
if($resultado_empresa->num_rows>0){ 
while($fila_empresa=$resultado_empresa->fetch_array()){
		  ...
		  if($anioempresa=='2018'){
			  ...
			  if($anioempresa=='2019'){
			  $rempresa2019=$fila_empresa['departamento'];
		  }
		  if($anioempresa=='2020'){
			  $rempresa2020=$fila_empresa['departamento'];
		  }
	if($anioempresa=='2021'){
			  $rempresa2021=$fila_empresa['departamento'];
		  }
		  
		  if($rempresa2019=='0'  or $rempresa2019 == null){
			   $var25='0.00';
		   }else{
		  $var25= number_format((($rempresa2020/$rempresa2019) - 1) * 100,2);
		   }
			 ...
			 if($rempresa2016=='0' or $rempresa2016 == null){
			  ...
			  if($rempresa2018=='0' or $rempresa2018 == null){
			  $ca7_9 ='0';
		      }else{
		      $ca7_9 = (($rempresa2019 / $rempresa2018) - 1) * 100;
		      }
			  if($rempresa2019=='0' or $rempresa2019 == null){
			  $ca8_9 ='0';
		      }else{
		      $ca8_9 = (($rempresa2020 / $rempresa2019) - 1) * 100;
		      }
	if($rempresa2020=='0' or $rempresa2020 == null){
			  $ca9_9 ='0';
		      }else{
		      $ca9_9 = (($rempresa2021 / $rempresa2020) - 1) * 100;
		      }
...
while($fila_prov=$resultado_prov->fetch_array()){
	...
	if($anioprov=='2021'){
		  ...
		  $var25x= number_format((($rprov2020/$rprov2019) - 1) * 100,2);
		   }
			 ...
			 if($rprov2016=='0' or $rprov2016 == null){
		      ...
		      $ca8_9x = (($rprov2019 / $rprov2018) - 1) * 100;
		      }
	if($rprov2020=='0' or $rprov2020 == null){
			  $ca9_9x ='0';
		      }else{
		      $ca9_9x = (($rprov2020 / $rprov2019) - 1) * 100;
		      }
	
			  $var26x= number_format(($ca1_9x + $ca2_9x + $ca3_9x + $ca4_9x + $ca5_9x + $ca6_9x + $ca7_9x + $ca8_9x)/8,2) ;
	...
	$rprov2021= "0.00";
	  ...
	  /*contamnos cantidad de distrito*/
	   $query_dist = "SELECT count(DISTINCT distrito.nombre) AS distrito, extract(year from exportacion.fnum) AS anio FROM exportacion LEFT JOIN distrito ON exportacion.ubigeo= distrito.iddistrito WHERE extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021' $querye AND exportacion.ndoc = '".$paiscode."' GROUP BY anio ORDER BY anio ASC";
...
while($fila_dist=$resultado_dist->fetch_array()){
	...
	if($aniodist=='2021'){
			  $distri2021=$fila_dist['distrito'];
			   ...
			   $vardist1='0.00';
		         ...
		         $vardist1= number_format((($distri2020/$distri2019) - 1) * 100,2);
		         }
	...
	if($distri2020=='0' or $distri2020 == null){
		...
		$ca9_dis = (($distri2020 / $distri2019) - 1) * 100;
		}
			  
	$vardist2= number_format(($ca1_dis + $ca2_dis + $ca3_dis + $ca4_dis + $ca5_dis + $ca6_dis + $ca7_dis + $ca8_dis)/8,2) ;
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Analisis Empresa Indicador Anual - Exportaciones </b><br> Empresa: $paisname │ Ruc: $paiscode │ Departamento: $namedepa1 │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>"; 
...
<script type="text/javascript">
    ...
    var options = {
      title : 'Reporte Analisis Empresa Anual - Exportaciones - <?php echo $paisname ?> / Departamento: <?=$namedepa1;?> / Periodo 2012 - 2021',
      vAxis: {title: 'Cups'},
      hAxis: {title: 'Years'},
      seriesType: 'bars',
      series: {6: {type: 'line'}}
