...
FROM exportacion
LEFT JOIN departamento ON substring(exportacion.ubigeo,1,2) = departamento.iddepartamento WHERE exportacion.ndoc = '".$paiscode."' $querytu AND ".$wherefecha." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion
LEFT JOIN departamento ON substring(exportacion.ubigeo,1,2) = departamento.iddepartamento
WHERE exportacion.ndoc = '".$paiscode."' $querytu AND ".$wherefecha." GROUP BY departamento.iddepartamento,departamento.nombre ";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Empresa Evoluci&oacute;n Anual de Exportaciones</b><br> Empresa: $paisname │ Ruc: $paiscode │ Departamento: $namedepa1 │ Variable #1: $combo - Variable #2: $combo2 │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
".$wherefecha." GROUP BY departamento.iddepartamento,departamento.nombre ";
  } else if($nombres2=="part_nandi" or $nombres2=="ndcl" or $nombres2=="dnombre" or $nombres2=="cpaides" or $nombres2=="cpuedes" or  $nombres2=="cadu" or $nombres2=="cage" or $nombres2=="cviatra"){
	  $query_resultadox = "SELECT
departamento.iddepartamento,
departamento.nombre,
...
while($fila_rptx=$resultado_rptx->fetch_array()){
		   ...
		   if($nombres2=="diferen"){
			   ...
			   $dife9A = $fila_rptx['x2020'];
			   $dife9B = $fila_rptx['xx2020'];
			   $dife10A = $fila_rptx['x2021'];
			   $dife10B = $fila_rptx['xx2021'];
		  ...
		  $year6= $fila_rptx['a2015'];
		  $year7= $fila_rptx['a2016'];
		  $year8= $fila_rptx['a2017'];
		  $year9= $fila_rptx['a2018'];
			   $year10= $fila_rptx['a2019'];
			   $year11= $fila_rptx['a2020'];
			   $year12= $fila_rptx['a2021'];
		   }
?>
...
<?php
  ...
  <center>
        <h3 class="title" id="emp"><font color="#FFFFFF"> Empresa: <?=$paisname;?> │ Departamento: <?=$namedepa1;?> │ Ubigeo Anual de Exportaciones │ <?=$combo;?> │ <?=$combo2;?> │ Periodo 2020 </font></h3></center>
