...
set_time_limit(750);
$paisname = $_POST["namempC"];
$paiscode = $_POST["codempC"];
...
/*realizamos conusulta del reporte selecionado y  actualizamos en la tabla temporal crada*/
 ...
 WHERE exportacion.ndoc='".$paiscode."' AND extract(year from exportacion.fnum) >= '2012' AND
extract(year from exportacion.fnum) <= '2021' $querytu GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="vpesnet"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, Sum(exportacion.vpesnet) as resultado FROM exportacion WHERE exportacion.ndoc = '".$paiscode."' AND extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021' $querytu GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="diferen"){
  ...
  if($onevar=="total"){
  $query1 = "SELECT exportacion.fano, extract(MONTH from exportacion.fnum) as mes, count(*) as resultado FROM exportacion WHERE exportacion.ndoc = '".$paiscode."' AND extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2021' $querytu GROUP BY exportacion.fano,mes ORDER BY exportacion.fano,mes";
  }
  if($onevar=="ndcl"){
...
extract(year from exportacion.fnum) <= '2021' $querytu AND exportacion.ndoc ='".$paiscode."'";
...
extract(year from exportacion.fnum) <= '2021' $querytu AND exportacion.ndoc ='".$paiscode."' GROUP BY anio order BY anio ASC";
...
echo"<div class='col-md-12'>";
	...
	echo"<div class='card-header card-header-info card-header-icon'>
              ...
              <h4 class='card-title'><b>Reporte Empresa Evolucion Anual de Exportaciones</b><br> Empresa: $paisname │ Ruc: $paiscode │ Departamento: $namedepa1 │ Variable: $combo │ Fecha Numeracion │ Periodo 2012 - 2021 </b> </h4>
            </div>";
...
while($fila_rptx=$resultado_rptx->fetch_array()){
	...
	$year12x= $fila_rptx['a2021'];
        ...
        var options = {
          title: 'Empresa <?php echo $paisname ?> - Departamento: <?=$namedepa1;?> -  Evolucion Anual de Exportaciones / <?php echo $combo ?> / 2012 - 2021',
          /*curveType: 'function',
