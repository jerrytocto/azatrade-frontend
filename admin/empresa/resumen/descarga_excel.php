...
header("Content-Disposition: attachment;filename=ResumenGeneral_Empresas.xls ");  
...
$sqlt="SELECT rp.varia_filtro, rp.codigo as ndoc, rp.descripcion, rp.anio1 AS a2012, rp.anio2 AS a2013, rp.anio3 AS a2014, rp.anio4 AS a2015, rp.anio5 AS a2016, rp.anio6 AS a2017, rp.anio7 AS a2018, rp.anio8 AS a2019, rp.anio9 AS a2020, rp.anio10 AS a2021, rp.variauno, rp.variados FROM resumen_empresas AS rp WHERE rp.varia_filtro = '$nombres2' AND rp.codigo <> 'Total'";
$resultado1=$conexpg->query($sqlt); 
	  ?>
<table cellspacing="0" cellpadding="0" width="100%" style="font-size:12px;">
<tr>
<td colspan="12" align="center"><b><font size="+2"><b>Reporte Resumen Anual de Indicadores</b><br> Empresas #: Todos │ Fecha Numeracion │ <?=$combo;?> │ Periodo 2012 - 2019 </b></font></b></td>
</tr>
                        <tr>
                            <td style='background:#CCC; color:#000'>N#. Ruc</td>
                            <td style='background:#CCC; color:#000'>Empresas</td>
