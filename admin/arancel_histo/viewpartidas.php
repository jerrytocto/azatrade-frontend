      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            ...
            <p>Encuentra tu partida por numero ó descripción de producto. <span class="w3-right "><a href="listsearch.php?buscar=<?php echo "$a"; ?>"><input class="w3-btn w3-margin-bottom" style="background:#EA6F31" type="button" value="Atrás" name="volver atrás2" /></a></span> </p>
            <!--<hr>
...
if (mysql_num_rows($rsnconve) > 0){
  ...
  ?>
    ...
    <tr>
    <td colspan="2" align="right"><a href="consultarpartida_exportar.php?data=<?php echo"$var"; ?>&d1=<?php echo"$subparti_nandina"; ?> "> Exportar: <img src="img/EXCEL.png" width="30" /></a> </td>
    </tr>-->
    </table>
