...
ara.Des_9,
ara.cuenta
FROM part_nandina AS nan
LEFT OUTER JOIN part_lista_aranceldepu AS ara ON nan.partida = ara.codigo_arancel
WHERE
concat(nan.partida,'',nan.descrip) LIKE '%".$q."%' OR
ara.Concatena_texto LIKE '%".$q."%' ORDER BY nan.partida ASC";
...
echo "<tr>";
if($colo=="9999"){
echo "<td width='100' class='success'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$codp</a></td>";
echo "<td class='success'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$descri</a></td>";
echo "<td width='80' class='success'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$fini</a></td>";
echo "<td width='80' class='success'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$ffin</a></td>";
}else{
echo "<td width='100' class='danger'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$codp</a></td>";
echo "<td class='danger'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$descri</a></td>";
echo "<td width='80' class='danger'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$fini</a></td>";
echo "<td width='80' class='danger'><a href='viewpartida.php?data=$codp&fi=$finix&ff=$ffinx&d1=$dato'>$ffin</a></td>";
}
echo "</tr>";
} 
echo "</table>";
