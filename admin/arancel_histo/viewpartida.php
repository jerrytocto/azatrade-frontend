...
//if (isset($consultar)){
  ...
  if($fa!=""){
  $sqlandina="SELECT nan.partida, nan.descrip, nan.adval, nan.igv, nan.isc, nan.seguro, nan.cuode, nan.ciiu, nan.finicio, nan.ffin FROM part_nandina AS nan WHERE nan.partida = '$var' and nan.finicio = '$fa' and nan.ffin = '$fb' ORDER BY nan.finicio DESC LIMIT 1 ";
  }else{
...
if (mysql_num_rows($rsnconve) > 0){
  ...
  ?>
    ...
    <tr>
    <td colspan="2" align="right"><a href="consultarpartida_exportar.php?data=<?php echo"$var"; ?>&d1=<?php echo"$subparti_nandina"; ?>&fi=<?php echo"$fa"; ?>&ff=<?php echo"$fb"; ?> ">Exportar: <img src="img/EXCEL.png" width="30" /></a> </td>
    </tr>
    </table>
