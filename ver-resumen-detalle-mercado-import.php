        ...
        <main class="main home">
          ...
          <div id="outer_div"></div>
			  ...
			  <div class="row mt-2 divide-line row-joined up-effect">
				  ...
				  <?php
$sqllist= "SELECT r.aniofn, r.mesfn as mes, CONVERT(r.mesfn,UNSIGNED INTEGER) as mesfn, sum(r.VFOB) AS VFOB, sum(r.cantreg) AS cantreg 
          FROM GranResumenImport_PowerBI AS r 
	WHERE r.pais_orige = '$code1' AND r.aniofn = '$code2' AND r.part_nandi = '$code3' 
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle-merca-import?dat=<?=$code1;?>&year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
