...
<head>
    ...
    <title>Azatrade - Uso Detalle</title>
...
<?php include("menu-flotante.php"); ?>
        ...
        <!-- End .header --> 
			...
			<section class="kenBurns-section mt-5 pt-5" style="padding: 0px 15px 0px;">
				<h3 align="center">Partidas Importadas por Uso: <?=$dato;?> -  <?=$dato2;?> </h3>
...
foreach($ggts as $dsx) {
	...
	$filaff12 = $dsx -> impo_vfobusdserdol1;
	$filaff13 = $dsx -> impo_vfobusdserdol2;
	$filaff14 = $dsx -> impo_vfobusdserdol3;
	$filaff15 = $dsx -> impo_vpesnet1;
	$filaff16 = $dsx -> impo_vpesnet2;
	$filaff17 = $dsx -> impo_vpesnet3;
	$filaff18 = $dsx -> impo_precio1;
	$filaff19 = $dsx -> impo_precio2;
	$filaff20 = $dsx -> impo_precio3;
   ...
   echo '<td>'.$filaff17.'</td>';
   echo '<td>'.$filaff20.'</td>';
	echo "<td><a href='partida-detalle-uso-general?year=2022&dat=$filaff2' target='_blank' class='btn btn-outline-primary btn-rounded btn-sm'>Ver Detalle</a></td>";
