...
WHERE
e.aniofn ='$dato2' AND CONCAT(e.dnombre,e.libr_tribu)='$dato' GROUP BY anio,e.part_nandi ORDER BY vfobx1 DESC";
...
?>
	<tr>
		...
		<td>
		<a href="ver-resumen-detalle-import?dat=<?=$dato;?>&year=<?=$dato2;?>&pk=<?=$tbb2;?>" target="_blank" class="btn btn-outline-primary btn-rounded btn-sm">Ver Detalle</button>
		</td>
	</tr>
