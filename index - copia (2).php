    ...
    <div class="page-wrapper">
        ...
        <main class="main home">
            <div class="container mb-2">
                ...
                <div class="row">
					<div class="col-lg-9" id="oculta"><div id="alert"></div></div>
					
                    <div class="col-lg-9" id="muestra">
						<!-- busqueda -->
...
<?php
  ...
  $('#buscador').keyup(function(){
    ...
    $('#busca').on('click', function (T){ 
		...
		var dato1 = $("#q")[0].value.length;
      if(dato1 === 0){
        $("input#q").focus();
		  swal({
      title: 'Campo Vacio!',
      text: "Ingrese producto a buscar",
      type: 'error',
      padding: '2em'
    });
        return false;
      ...
      padding: '2em'
        ...
        divc = document.getElementById('oculta');
        divc.style.display = '';
		divd = document.getElementById('muestra');
      ...
      paqueteDeDatosRegi.append('q', $('#q').prop('value'));
	  paqueteDeDatosRegi.append('cate', $('#cate').prop('value'));
      var destino = "muestraproductos.php"; 
      $.ajax({
        url:destino,type:'POST',contentType:false,data:paqueteDeDatosRegi,processData:false,cache:false,
        beforeSend:function(){ $("#alert").html("<center><img src='assets/images/loading.gif' width='32px' ><br> <b>Procesando Consulta, esto puede tardar unos minutos, espere por favor...</b></center>"); },
        success:function(data){ $('#alert').html(data); $('#busca').val("Consultar"); },
		...
		//oculta
		diva = document.getElementById('oculta');
...
$(document).ready(function() {	
    $('.pagination li a').on('click', function(){
        $('.items').html('<div class="loading"><img src="assets/images/loading.gif" width="70px" height="70px"/><br/>Un momento por favor...</div>');
