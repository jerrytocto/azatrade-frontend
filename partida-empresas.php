...
FROM GranResumenExport_PowerBI as e WHERE e.PART_NANDI = '$code1' AND aniofn >= '2012' AND aniofn <= '$aniogen' GROUP BY e.DNOMBRE, e.NDOC ORDER BY a2022 DESC";
