...
// consultamos pais
/*$seep = "SELECT id, nombre FROM departamento WHERE iddepartamento='$code1' LIMIT 1";
        ...
        <main class="main home">
          ...
          <div id="outer_div"></div>
			  ...
			  <div class="row mt-2 divide-line row-joined up-effect">
				  ...
				  <?php
/*$sqllist= "SELECT r.aniofn, r.mesfn as mes, CONVERT(r.mesfn,UNSIGNED INTEGER) as mesfn, sum(r.VFOBSERDOL) AS VFOBSERDOL, sum(r.cantreg) AS cantreg 
          FROM GranResumenExport_PowerBI AS r 
	WHERE r.aniofn = '$code2' AND r.PART_NANDI = '$code3' 
	GROUP BY r.aniofn, r.mesfn 
	ORDER BY mesfn ASC";*/
$sqllist= "SELECT YEAR(r.FNUM) as aniofn, MONTH(r.FNUM) as mes, CONVERT(MONTH(r.FNUM),UNSIGNED INTEGER) as mesfn, sum(r.VFOBSERDOL) AS VFOBSERDOL, 
count(r.PART_NANDI) AS cantreg 
          FROM exportacion AS r 
	WHERE YEAR(r.FNUM) = '$code2' AND r.PART_NANDI = '$code3' AND CONCAT(r.DCOM,r.DMER2,r.DMER3,r.DMER4,r.DMER5) like '%$code1%'	
	GROUP BY aniofn, mesfn 
	ORDER BY mesfn ASC";
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle-partida?dat=<?=$code1;?>&year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
