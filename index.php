          ...
          <!-- END AJAX -->
                        ...
                        <div class="home-slider slide-animate owl-carousel owl-theme mb-2" data-owl-options="{
                            ...
                            <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                                <img class="slide-bg" style="background-color: #2699D0;" src="assets/images/demoes/demo1/slider/Baner_4.png" width="880" height="428" alt="home-slider">
...
foreach($glds as $shht) {
	...
	$filaff7x1 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x1;?>&year=<?=$filaff7x1;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x2 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x2;?>&year=<?=$filaff7x2;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x3 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x3;?>&year=<?=$filaff7x3;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x4 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x4;?>&year=<?=$filaff7x4;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x5 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x5;?>&year=<?=$filaff7x5;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x6 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x6;?>&year=<?=$filaff7x6;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x7 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x7;?>&year=<?=$filaff7x7;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x8 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x8;?>&year=<?=$filaff7x8;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x9 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x9;?>&year=<?=$filaff7x9;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x10 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x10;?>&year=<?=$filaff7x10;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x11 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x11;?>&year=<?=$filaff7x11;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x12 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x12;?>&year=<?=$filaff7x12;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x13 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x13;?>&year=<?=$filaff7x13;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x14 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x14;?>&year=<?=$filaff7x14;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x15 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x15;?>&year=<?=$filaff7x15;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x16 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x16;?>&year=<?=$filaff7x16;?>' target="_blank" class='btn btn-primary btn-xs'><b>VER M&Aacute;S</b></a> </p>
						...
						<div class="widget widget-banners px-3 pb-3 text-center">
							...
							<nav class="side-nav">
                                <ul class="menu menu-vertical sf-arrows">
									<?php
$sdlt = "SELECT concat(tipo,sector) as codsec, concat(tipo,' - ',sector) as sector, sector as nomsec, tipo, sector as nomsecto FROM sectores WHERE sector<>'No Identificado' GROUP BY tipo, sector ORDER BY sector ASC";
...
foreach($sds as $spt) {
	...
	echo "<li class='item'><a href='sectores?dat=$dsl3&year=$dsl4' target='_blank' class='nombres'><i class='sicon-globe'></i>$dsl5</a></li>";
	}
}else{
									?>
