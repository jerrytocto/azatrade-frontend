...
$sqtrp = "SELECT i.* FROM importacion AS i WHERE YEAR(i.fech_ingsi) = '$code2' AND MONTH(i.fech_ingsi) = '$code4' AND i.part_nandi='$code3' AND i.pais_orige='$code1'  limit 1000 ";
$partslqt = $conexpg -> prepare($sqtrp); 
$partslqt -> execute(); 
$ggts = $partslqt -> fetchAll(PDO::FETCH_OBJ); 
if($partslqt -> rowCount() > 0) { 
