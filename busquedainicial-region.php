...
/*$cxreg = "SELECT COUNT(*) as total FROM (SELECT e.part_nandi FROM exportacion e WHERE YEAR(e.fnum) ='$dato2' AND substr(e.UBIGEO,1,2)='$dato' GROUP BY e.part_nandi) AS Total";
...
exportacion e
WHERE
YEAR(e.fnum) ='$dato2' AND substr(e.UBIGEO,1,2)='$dato' GROUP BY anio,e.part_nandi";*/
