...
// consultamos ruc
$seep = "SELECT CONCAT(DNOMBRE,NDOC) as DNOMBRE1, CONCAT(DNOMBRE,' - ',NDOC) as DNOMBRE2 FROM GranResumenExport_PowerBI WHERE NDOC='$code1' LIMIT 1";
...
$sqllist= "SELECT r.aniofn, r.mesfn as mes, CONVERT(r.mesfn,UNSIGNED INTEGER) as mesfn, sum(r.VFOBSERDOL) AS VFOBSERDOL, sum(r.cantreg) AS cantreg 
	...
	WHERE r.NDOC = '$code1' AND r.aniofn = '$code2' AND r.PART_NANDI = '$code3' 
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle?dat=<?=$code1;?>&year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
