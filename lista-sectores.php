...
$cxreg = "SELECT COUNT(*) as total FROM (SELECT p.partida_nandi	FROM productos AS p 
	WHERE p.tipo_sec='$dato' AND p.sector='$dato2' AND p.imgfoto<>'' ) AS Total";
...
foreach($gts as $fhht) {
	...
	FROM productos AS p 
	WHERE p.tipo_sec='$dato' AND p.sector='$dato2' AND p.imgfoto<>'' ORDER BY p.mostrar DESC LIMIT $offset,$per_page";
...
if($rdrpt -> rowCount() > 0) { 
	...
	$filaff12 = $frvpt -> vfobusdserdol1;
	$filaff13 = $frvpt -> vfobusdserdol2;
	$filaff14 = $frvpt -> vfobusdserdol3;
	$filaff15 = $frvpt -> vpesnet1;
	$filaff16 = $frvpt -> vpesnet2;
	$filaff17 = $frvpt -> vpesnet3;
	$filaff18 = $frvpt -> precio1;
	$filaff19 = $frvpt -> precio2;
	$filaff20 = $frvpt -> precio3;
    ...
    <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
										...
										<a href="partida-detalle?dat=<?=$filaff2;?>&year=2022" target="_blank">Partida: <?=$filaff2;?> </a> 
										</h3>
                                        ...
                                        <div class="product-action">
                                            <a href="sector-producto?dat=<?=$filaff2;?>&pk=<?=$filaff1;?>" target="_blank" class="btn-icon btn-add-cart"><i
...
<?php } ?>
	...
	<hr>
	<center><a href="sectores-view.php?data=<?=$dato;?>&year=<?=$dato2;?>" target="_blank" class="btn btn-dark btn-sm">VER TODOS</a></center>
	</div>
<?php }else{ ?>
