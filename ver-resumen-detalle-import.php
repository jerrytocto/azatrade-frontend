...
// consultamos ruc
$seep = "SELECT CONCAT(dnombre,libr_tribu) as DNOMBRE1, CONCAT(dnombre,' - ',libr_tribu) as DNOMBRE2 FROM GranResumenImport_PowerBI WHERE CONCAT(dnombre,libr_tribu)='$code1' LIMIT 1";
...
<head>
    ...
    <title>Azatrade -Resumen Importacion</title>
        ...
        <main class="main home">
          ...
          <div id="outer_div"></div>
			  ...
			  <div class="row mt-2 divide-line row-joined up-effect">
				  ...
				  <?php
$sqllist= "SELECT r.aniofn, r.mesfn as mes, CONVERT(r.mesfn,UNSIGNED INTEGER) as mesfn, sum(r.VFOB) AS VFOBSERDOL, sum(r.cantreg) AS cantreg 
          FROM GranResumenImport_PowerBI AS r 
	WHERE CONCAT(r.dnombre,r.libr_tribu) = '$code1' AND r.aniofn = '$code2' AND r.part_nandi = '$code3' 
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle-empresa-import?dat=<?=$code1;?>&year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
