...
SUM(CASE e.aniofn WHEN '2022' THEN $varianom ELSE 0 END) AS a2022,
SUM(CASE e.aniofn WHEN '2023' THEN $varianom ELSE 0 END) AS a2023
FROM GranResumenExport_PowerBI as e WHERE e.PART_NANDI = '$code1' AND aniofn >= '2012' AND aniofn <= '$aniogen' GROUP BY ubi1 ORDER BY a2022 DESC";
